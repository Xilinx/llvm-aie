...
function(get_arch_and_system_from_triple triple arch_var sys_var)
  ...
  elseif(target_arch MATCHES "^aie2ps")
    set(target_arch "aie2ps")
  elseif(target_arch MATCHES "^aie2p")
    set(target_arch "aie2p")
...
elseif(LIBC_TARGET_ARCHITECTURE STREQUAL "aie2")
  set(LIBC_TARGET_ARCHITECTURE_IS_AIE TRUE)
elseif(LIBC_TARGET_ARCHITECTURE STREQUAL "aie2p")
  set(LIBC_TARGET_ARCHITECTURE_IS_AIE TRUE)
elseif(LIBC_TARGET_ARCHITECTURE STREQUAL "aie2ps")
  set(LIBC_TARGET_ARCHITECTURE_IS_AIE TRUE)
