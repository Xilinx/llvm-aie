...
// RUN: %clang_cc1 -triple aie %s -std=c++14 -triple=spir -verify -fsyntax-only
// RUN: %clang_cc1 -triple aie %s -std=c++17 -triple=spir -verify -fsyntax-only
// RUN: %clang_cc1 -triple aie2 %s -std=c++14 -triple=spir -verify -fsyntax-only
// RUN: %clang_cc1 -triple aie2 %s -std=c++17 -triple=spir -verify -fsyntax-only
