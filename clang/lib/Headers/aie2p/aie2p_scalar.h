...
#ifndef __AIE2P_SCALAR_H__
#define __AIE2P_SCALAR_H__

INTRINSIC(int) get_coreid() { return __builtin_aie2p_get_coreid(); }
...
INTRINSIC(unsigned) clb(int x) { return __builtin_aie2p_clb(x); }
