...
inline v16accfloat mul_4x8_8x4_accuracy_safe(v32float v1, v32float v2) {
  ...
  v32bfloat16 f;
  v32bfloat16 dummy0 =
      ::shuffle(broadcast_one_to_v32bfloat16(), broadcast_zero_to_v32bfloat16(),
                INTLV_lo_256o512);
  v32bfloat16 dummy1 =
      ::shuffle(broadcast_zero_to_v32bfloat16(), broadcast_one_to_v32bfloat16(),
                INTLV_lo_256o512);
              ...
              mac_4x8_8x4(
                  ...
                  mac_4x8_8x4(
                      ...
                      mac_4x8_8x4(
                          a, f,
                          mac_4x8_8x4(
                              b, f, mac_4x8_8x4(c, e, mul_4x8_8x4(c, f)))))))));
}
...
inline v16accfloat mul_4x8_8x4_accuracy_fast(v32float v1, v32float v2) {
  ...
  return mac_4x8_8x4(
      ...
      mac_4x8_8x4(
          a, e,
          mac_4x8_8x4(
              b, d, mac_4x8_8x4(d, c, mac_4x8_8x4(b, e, mul_4x8_8x4(a, f))))));
}
...
inline v16accfloat mac_4x8_8x4_accuracy_fast(v32float v1, v32float v2,
  ...
  return addmac_4x8_8x4(
      ...
      mac_4x8_8x4(
          a, e,
          mac_4x8_8x4(b, d,
                      mac_4x8_8x4(d, c, mac_4x8_8x4(b, e, mul_4x8_8x4(a, f))))),
      acc);
}
...
inline v16accfloat negmul_4x8_8x4(v32float v1, v32float v2) {
  return negmul_4x8_8x4_accuracy_low(v1, v2);
}
inline v16accfloat mac_4x8_8x4(v32float v1, v32float v2, v16accfloat acc) {
  return mac_4x8_8x4_accuracy_low(v1, v2, acc);
}
inline v16accfloat msc_4x8_8x4(v32float v1, v32float v2, v16accfloat acc) {
  return msc_4x8_8x4_accuracy_low(v1, v2, acc);
}
inline v16accfloat addmac_4x8_8x4(v32float v1, v32float v2, v16accfloat acc1,
                                  v16accfloat acc2) {
  return addmac_4x8_8x4_accuracy_low(v1, v2, acc1, acc2);
}
inline v16accfloat addmsc_4x8_8x4(v32float v1, v32float v2, v16accfloat acc1,
                                  v16accfloat acc2) {
...
inline v16accfloat negmul_4x8_8x4(v32float v1, v32float v2) {
  return negmul_4x8_8x4_accuracy_safe(v1, v2);
}
inline v16accfloat mac_4x8_8x4(v32float v1, v32float v2, v16accfloat acc) {
  return mac_4x8_8x4_accuracy_safe(v1, v2, acc);
}
inline v16accfloat msc_4x8_8x4(v32float v1, v32float v2, v16accfloat acc) {
  return msc_4x8_8x4_accuracy_safe(v1, v2, acc);
}
inline v16accfloat addmac_4x8_8x4(v32float v1, v32float v2, v16accfloat acc1,
                                  v16accfloat acc2) {
  return addmac_4x8_8x4_accuracy_safe(v1, v2, acc1, acc2);
}
inline v16accfloat addmsc_4x8_8x4(v32float v1, v32float v2, v16accfloat acc1,
                                  v16accfloat acc2) {
