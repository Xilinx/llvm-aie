...
#ifndef __AIE2P_ADDR_H__
#define __AIE2P_ADDR_H__
...
add_2d_ptr(T *a, int off, int size1, int &count1, int inc1) {
  return (T *)__builtin_aie2p_add_2d((void *)a, (off * sizeof(T)),
...
add_2d_byte(T *a, int off, int size1, int &count1, int inc1) {
  return (T *)__builtin_aie2p_add_2d((void *)a, off, inc1, size1, count1);
}
...
add_3d_ptr(T *a, int off, int size1, int &count1, int inc1, int size2,
           int &count2, int inc2) {
  return (T *)__builtin_aie2p_add_3d((void *)a, (off * sizeof(T)),
...
add_3d_byte(T *a, int off, int size1, int &count1, int inc1, int size2,
            int &count2, int inc2) {
  return (T *)__builtin_aie2p_add_3d((void *)a, off, inc1, inc2, size1, count1,
                                     size2, count2);
}
...
INTRINSIC(v8int32) load_4x16_hi(v8int32 addr) {
  return __builtin_aie2p_load_4x16_hi(addr);
}
INTRINSIC(v8int32) load_4x32_lo(v8int32 addr) {
  return __builtin_aie2p_load_4x32_lo(addr);
}
INTRINSIC(v8int32) load_4x32_hi(v8int32 addr) {
  return __builtin_aie2p_load_4x32_hi(addr);
}
INTRINSIC(v8int32) load_4x64_lo(v8int32 addr) {
  return __builtin_aie2p_load_4x64_lo(addr);
}
INTRINSIC(v8int32) load_4x64_hi(v8int32 addr) {
  return __builtin_aie2p_load_4x64_hi(addr);
}
INTRINSIC(v16int32)
