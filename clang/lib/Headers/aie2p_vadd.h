...
#ifndef __AIE2P_VADD_H__
#define __AIE2P_VADD_H__
...
INTRINSIC(v64uint8) addsub(v64uint8 a, v64uint8 b, unsigned long long as) {
  return __builtin_aie2p_vaddsub8(a, b, (v2int32)as);
}
INTRINSIC(v64uint8) neg_gtz(v64uint8 a, unsigned long long &cmp) {
  return __builtin_aie2p_vneg_gtz8(a, cmp);
}
...
{
  return __builtin_aie2p_vsub_lt8(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v64uint8)
sub_lt(v64uint8 a, v64uint8 b, bool sgn,
       unsigned long long &cmp) // dynamic sign
{
  return __builtin_aie2p_vsub_lt8(a, b, sgn, cmp);
}

INTRINSIC(v64uint8)
sub_ge(v64uint8 a, v64uint8 b, unsigned long long &cmp) // static sign
{
  return __builtin_aie2p_vsub_ge8(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v64uint8)
sub_ge(v64uint8 a, v64uint8 b, bool sgn,
       unsigned long long &cmp) // dynamic sign
{
  return __builtin_aie2p_vsub_ge8(a, b, sgn, cmp);
}

INTRINSIC(v64uint8)
maxdiff_lt(v64uint8 a, v64uint8 b, unsigned long long &cmp) // static sign
{
  return __builtin_aie2p_vmaxdiff_lt8(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v64uint8)
maxdiff_lt(v64uint8 a, v64uint8 b, bool sgn,
           unsigned long long &cmp) // dynamic sign
{
  return __builtin_aie2p_vmaxdiff_lt8(a, b, sgn, cmp);
}
INTRINSIC(v64uint8)
...
{
  return __builtin_aie2p_vmin_ge8(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v64uint8)
min_ge(v64uint8 a, v64uint8 b, bool sgn,
       unsigned long long &cmp) // dynamic sign
{
  return __builtin_aie2p_vmin_ge8(a, b, sgn, cmp);
}
INTRINSIC(v64uint8)
...
{
  return __builtin_aie2p_vmax_lt8(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v64uint8)
max_lt(v64uint8 a, v64uint8 b, bool sgn,
       unsigned long long &cmp) // dynamic sign
{
  return __builtin_aie2p_vmax_lt8(a, b, sgn, cmp);
}
INTRINSIC(v64uint8)
...
{
  return __builtin_aie2p_vabs_gtz8(a, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v64uint8)
abs_gtz(v64uint8 a, bool sgn, unsigned long long &cmp) // dynamic sign
{
  return __builtin_aie2p_vabs_gtz8(a, (uint1_t)sgn, cmp);
}
INTRINSIC(v64uint8)
...
{
  return (unsigned long long)__builtin_aie2p_vlt8(a, b, __SIGN_UNSIGNED);
}
INTRINSIC(unsigned long long)
ge(v64uint8 a, v64uint8 b) // static sign
{
  return (unsigned long long)__builtin_aie2p_vge8(a, b, __SIGN_UNSIGNED);
}
...
{
  return (unsigned long long)__builtin_aie2p_vlt8(a, b, sgn);
}
INTRINSIC(unsigned long long)
ge(v64uint8 a, v64uint8 b, bool sgn) // dynamic sign
{
  return (unsigned long long)__builtin_aie2p_vge8(a, b, sgn);
}
...
INTRINSIC(unsigned long long) eqz(v64uint8 a) {
  return (unsigned long long)__builtin_aie2p_veqz8(a);
}
...
INTRINSIC(v64uint8) sel(v64uint8 a, v64uint8 b, unsigned long long sel) {
  return __builtin_aie2p_vsel8(a, b, (v2int32)sel);
}
...
{
  return __builtin_aie2p_vsub_lt8(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v64int8)
...
{
  return __builtin_aie2p_vsub_ge8(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v64int8)
...
{
  return __builtin_aie2p_vmaxdiff_lt8(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v64int8)
...
{
  return __builtin_aie2p_vmin_ge8(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v64int8)
...
{
  return __builtin_aie2p_vmax_lt8(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v64int8)
...
{
  return __builtin_aie2p_vabs_gtz8(a, __SIGN_SIGNED, cmp);
}
INTRINSIC(v64int8)
...
{
  return (unsigned long long)__builtin_aie2p_vlt8(a, b, __SIGN_SIGNED);
}
INTRINSIC(unsigned long long)
ge(v64int8 a, v64int8 b) // static sign
{
  return (unsigned long long)__builtin_aie2p_vge8(a, b, __SIGN_SIGNED);
}
...
INTRINSIC(v32uint16) addsub(v32uint16 a, v32uint16 b, unsigned int as) {
  return __builtin_aie2p_vaddsub16(a, b, as);
}
INTRINSIC(v32uint16) neg_gtz(v32uint16 a, unsigned int &cmp) {
  return __builtin_aie2p_vneg_gtz16(a, cmp);
}
...
{
  return __builtin_aie2p_vmin_ge16(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v32uint16)
min_ge(v32uint16 a, v32uint16 b, bool sgn, unsigned int &cmp) // dynamic sign
{
  return __builtin_aie2p_vmin_ge16(a, b, sgn, cmp);
}
INTRINSIC(v32uint16)
...
{
  return __builtin_aie2p_vmax_lt16(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v32uint16)
max_lt(v32uint16 a, v32uint16 b, bool sgn, unsigned int &cmp) // dynamic sign
{
  return __builtin_aie2p_vmax_lt16(a, b, sgn, cmp);
}
INTRINSIC(v32uint16)
...
{
  return __builtin_aie2p_vabs_gtz16(a, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v32uint16)
abs_gtz(v32uint16 a, bool sgn, unsigned int &cmp) // dynamic sign
{
  return __builtin_aie2p_vabs_gtz16(a, (uint1_t)sgn, cmp);
}
INTRINSIC(v32uint16)
...
{
  return (unsigned int)__builtin_aie2p_vlt16(a, b, __SIGN_UNSIGNED);
}
INTRINSIC(unsigned int)
ge(v32uint16 a, v32uint16 b) // static sign
{
  return (unsigned int)__builtin_aie2p_vge16(a, b, __SIGN_UNSIGNED);
}
...
{
  return (unsigned int)__builtin_aie2p_vlt16(a, b, sgn);
}
INTRINSIC(unsigned int)
ge(v32uint16 a, v32uint16 b, bool sgn) // dynamic sign
{
  return (unsigned int)__builtin_aie2p_vge16(a, b, sgn);
}
...
INTRINSIC(unsigned int) eqz(v32uint16 a) {
  return (unsigned int)__builtin_aie2p_veqz16(a);
}
...
INTRINSIC(v32uint16) sel(v32uint16 a, v32uint16 b, unsigned int sel) {
  return __builtin_aie2p_vsel16(a, b, sel);
}
...
{
  return __builtin_aie2p_vsub_lt16(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v32int16)
...
{
  return __builtin_aie2p_vsub_ge16(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v32int16)
...
{
  return __builtin_aie2p_vmaxdiff_lt16(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v32int16)
...
{
  return __builtin_aie2p_vmin_ge16(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v32int16)
...
{
  return __builtin_aie2p_vmax_lt16(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v32int16)
...
{
  return __builtin_aie2p_vabs_gtz16(a, __SIGN_SIGNED, cmp);
}
INTRINSIC(v32int16)
...
{
  return (unsigned int)__builtin_aie2p_vlt16(a, b, __SIGN_SIGNED);
}
INTRINSIC(unsigned int)
ge(v32int16 a, v32int16 b) // static sign
{
  return (unsigned int)__builtin_aie2p_vge16(a, b, __SIGN_SIGNED);
}
...
INTRINSIC(v16uint32) addsub(v16uint32 a, v16uint32 b, unsigned int as) {
  return __builtin_aie2p_vaddsub32(a, b, as);
}
INTRINSIC(v16uint32) neg_gtz(v16uint32 a, unsigned int &cmp) {
  return __builtin_aie2p_vneg_gtz32(a, cmp);
}
...
{
  return __builtin_aie2p_vsub_lt32(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v16uint32)
sub_lt(v16uint32 a, v16uint32 b, bool sgn, unsigned int &cmp) // dynamic sign
{
  return __builtin_aie2p_vsub_lt32(a, b, sgn, cmp);
}

INTRINSIC(v16uint32)
sub_ge(v16uint32 a, v16uint32 b, unsigned int &cmp) // static sign
{
  return __builtin_aie2p_vsub_ge32(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v16uint32)
sub_ge(v16uint32 a, v16uint32 b, bool sgn, unsigned int &cmp) // dynamic sign
{
  return __builtin_aie2p_vsub_ge32(a, b, sgn, cmp);
}

INTRINSIC(v16uint32)
maxdiff_lt(v16uint32 a, v16uint32 b, unsigned int &cmp) // static sign
{
  return __builtin_aie2p_vmaxdiff_lt32(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v16uint32)
maxdiff_lt(v16uint32 a, v16uint32 b, bool sgn,
           unsigned int &cmp) // dynamic sign
{
  return __builtin_aie2p_vmaxdiff_lt32(a, b, sgn, cmp);
}
INTRINSIC(v16uint32)
...
{
  return __builtin_aie2p_vmin_ge32(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v16uint32)
min_ge(v16uint32 a, v16uint32 b, bool sgn, unsigned int &cmp) // dynamic sign
{
  return __builtin_aie2p_vmin_ge32(a, b, sgn, cmp);
}
INTRINSIC(v16uint32)
...
{
  return __builtin_aie2p_vmax_lt32(a, b, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v16uint32)
max_lt(v16uint32 a, v16uint32 b, bool sgn, unsigned int &cmp) // dynamic sign
{
  return __builtin_aie2p_vmax_lt32(a, b, sgn, cmp);
}
INTRINSIC(v16uint32)
...
{
  return __builtin_aie2p_vabs_gtz32(a, __SIGN_UNSIGNED, cmp);
}
INTRINSIC(v16uint32)
abs_gtz(v16uint32 a, bool sgn, unsigned int &cmp) // dynamic sign
{
  return __builtin_aie2p_vabs_gtz32(a, (uint1_t)sgn, cmp);
}
INTRINSIC(v16uint32)
...
{
  return (unsigned int)__builtin_aie2p_vlt32(a, b, __SIGN_UNSIGNED);
}
INTRINSIC(unsigned int)
ge(v16uint32 a, v16uint32 b) // static sign
{
  return (unsigned int)__builtin_aie2p_vge32(a, b, __SIGN_UNSIGNED);
}
...
{
  return (unsigned int)__builtin_aie2p_vlt32(a, b, sgn);
}
INTRINSIC(unsigned int)
ge(v16uint32 a, v16uint32 b, bool sgn) // dynamic sign
{
  return (unsigned int)__builtin_aie2p_vge32(a, b, sgn);
}
...
INTRINSIC(unsigned int) eqz(v16uint32 a) {
  return (unsigned int)__builtin_aie2p_veqz32(a);
}
...
INTRINSIC(v16uint32) sel(v16uint32 a, v16uint32 b, unsigned int sel) {
  return __builtin_aie2p_vsel32(a, b, sel);
}
...
{
  return __builtin_aie2p_vsub_lt32(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v16int32)
...
{
  return __builtin_aie2p_vsub_ge32(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v16int32)
...
{
  return __builtin_aie2p_vmaxdiff_lt32(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v16int32)
...
{
  return __builtin_aie2p_vmin_ge32(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v16int32)
...
{
  return __builtin_aie2p_vmax_lt32(a, b, __SIGN_SIGNED, cmp);
}
INTRINSIC(v16int32)
...
{
  return __builtin_aie2p_vabs_gtz32(a, __SIGN_SIGNED, cmp);
}
INTRINSIC(v16int32)
...
{
  return (unsigned int)__builtin_aie2p_vlt32(a, b, __SIGN_SIGNED);
}
INTRINSIC(unsigned int)
ge(v16int32 a, v16int32 b) // static sign
{
  return (unsigned int)__builtin_aie2p_vge32(a, b, __SIGN_SIGNED);
}
...
{
  return __builtin_aie2p_vmin_gebf16(a, b, cmp);
}
INTRINSIC(v32bfloat16)
...
{
  return __builtin_aie2p_vmax_ltbf16(a, b, cmp);
}
INTRINSIC(v32bfloat16)
...
{
  return (unsigned int)__builtin_aie2p_vltbf16(a, b);
}
INTRINSIC(unsigned int)
ge(v32bfloat16 a, v32bfloat16 b) // static sign
{

  return (unsigned int)__builtin_aie2p_vgebf16(a, b);
}
...
INTRINSIC(unsigned int) eqz(v32bfloat16 a) { return __builtin_aie2p_veqz16(a); }
...
INTRINSIC(v16float) abs(v16float v1) {
  return (v16float)band((v16uint32)v1,
                        broadcast_to_v16uint32((unsigned int)(0x7fffffff)));
}
...
INTRINSIC(v16float) sel(v16float a, v16float b, unsigned int sel) {
  return (v16float)__builtin_aie2p_vsel32(a, b, sel);
}
...
INTRINSIC(v16int32) bfloat16_to_int(v16bfloat16 a, int shft) {
  return __builtin_aie2p_v16bf16_to_v16i32(a, shft);
}

#endif // __AIE2P_VADD_H__
