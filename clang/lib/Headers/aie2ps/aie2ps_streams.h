...
#ifndef __AIE2PS_STREAMS_H__
#define __AIE2PS_STREAMS_H__

INTRINSIC(v16acc32) get_scd_v16acc32(int en) {
  return __builtin_aie2ps_scd_read_acc32(en);
}
INTRINSIC(v8acc64) get_scd_v8acc64(int en) {
  return (v8acc64)__builtin_aie2ps_scd_read_acc32(en);
}
...
INTRINSIC(v128int4) get_scd_v128int4(int en) {
  return (v128int4)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v128uint4) get_scd_v128uint4(int en) {
  return (v128uint4)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v64int8) get_scd_v64int8(int en) {
  return (v64int8)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v64uint8) get_scd_v64uint8(int en) {
  return (v64uint8)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v32int16) get_scd_v32int16(int en) {
  return (v32int16)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v32uint16) get_scd_v32uint16(int en) {
  return (v32uint16)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v16int32) get_scd_v16int32(int en) {
  return (v16int32)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v16uint32) get_scd_v16uint32(int en) {
  return (v16uint32)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v32bfloat16) get_scd_v32bfloat16(int en) {
  return (v32bfloat16)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v16float) get_scd_v16float(int en) {
  return (v16float)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v32float16) get_scd_v32float16(int en) {
  return (v32float16)__builtin_aie2ps_scd_read_vec(en);
}
INTRINSIC(v64float8) get_scd_v64float8(int en) {
  return {(v64int8)__builtin_aie2ps_scd_read_vec(en)};
}
INTRINSIC(v64bfloat8) get_scd_v64bfloat8(int en) {
  return {(v64int8)__builtin_aie2ps_scd_read_vec(en)};
}
...
INTRINSIC(v32float16) get_scd_v32float16() { return get_scd_v32float16(1); }
INTRINSIC(v64float8) get_scd_v64float8() { return get_scd_v64float8(1); }
INTRINSIC(v64bfloat8) get_scd_v64bfloat8() { return get_scd_v64bfloat8(1); }
...
INTRINSIC(v64float16) get_scd_v64float16(int en) {
  return (v64float16)get_scd_v32int32(en);
}
INTRINSIC(v64bfloat16) get_scd_v64bfloat16(int en) {
  return (v64bfloat16)get_scd_v32int32(en);
}
...
INTRINSIC(v64float16) get_scd_v64float16() { return get_scd_v64float16(1); }
INTRINSIC(v64bfloat16) get_scd_v64bfloat16() { return get_scd_v64bfloat16(1); }
...
INTRINSIC(v32acc32) get_scd_v32acc32_lo(int en) {
  return __builtin_aie2ps_scd_expand_lo(en);
}
INTRINSIC(v32acc32) get_scd_v32acc32_hi(int en) {
  return __builtin_aie2ps_scd_expand_hi(en);
}
...
INTRINSIC(v32acc32) get_scd_expand_v32acc32_incr(int en, int &pos) {
  return __builtin_aie2ps_scd_expand_ACC1024_incr(en, (void *)pos, pos);
}
...
INTRINSIC(v32acc32) get_scd_expand_v32acc32(int en, int pos) {
  return __builtin_aie2ps_scd_expand_ACC1024(en, pos);
}
...
INTRINSIC(v64acc32) get_scd_v64acc32_0(int en) {
  return __builtin_aie2ps_scd_ACC2048(en, 0);
}
INTRINSIC(v64acc32) get_scd_v64acc32_1(int en) {
  return __builtin_aie2ps_scd_ACC2048(en, 1);
}
INTRINSIC(v64acc32) get_scd_v64acc32_2(int en) {
  return __builtin_aie2ps_scd_ACC2048(en, 2);
}
INTRINSIC(v64acc32) get_scd_v64acc32_3(int en) {
  return __builtin_aie2ps_scd_ACC2048(en, 3);
}
...
INTRINSIC(v64acc32) get_scd_expand_v64acc32_incr(int en, int &pos) {
  return __builtin_aie2ps_scd_expand_ACC2048_incr(en, (void *)pos, pos);
}
...
INTRINSIC(v64acc32) get_scd_expand_v64acc32(int en, int pos) {
  return __builtin_aie2ps_scd_expand_ACC2048(en, pos);
}
...
INTRINSIC(void) put_mcd(v16acc32 a, int en) {
  __builtin_aie2ps_mcd_write_acc32(a, en);
}
...
INTRINSIC(void) put_mcd(v128int4 a, int en) {
  __builtin_aie2ps_mcd_write_vec(a, en);
}
...
INTRINSIC(void) put_mcd(v32float16 a, int en) {
  __builtin_aie2ps_mcd_write_vec(a, en);
}
INTRINSIC(void) put_mcd(v64float8 a, int en) {
  __builtin_aie2ps_mcd_write_vec(a.data, en);
}
INTRINSIC(void) put_mcd(v64bfloat8 a, int en) {
  __builtin_aie2ps_mcd_write_vec(a.data, en);
}
...
INTRINSIC(void) put_mcd(v32float16 a) { put_mcd(a, 1); }
INTRINSIC(void) put_mcd(v64float8 a) { put_mcd(a, 1); }
INTRINSIC(void) put_mcd(v64bfloat8 a) { put_mcd(a, 1); }
...
INTRINSIC(void) put_mcd(v64float16 a, int en) { put_mcd((v32int32)a, en); }
INTRINSIC(void) put_mcd(v64bfloat16 a, int en) { put_mcd((v32int32)a, en); }
...
INTRINSIC(void) put_mcd(v64float16 a) { put_mcd(a, 1); }
INTRINSIC(void) put_mcd(v64bfloat16 a) { put_mcd(a, 1); }

#define PUT_MS(TYPE)                                                           \
  INTRINSIC(void) put_ms(TYPE val, int tlast) {                                \
    __builtin_aie2ps_put_ms((int)val, tlast);                                  \
  }                                                                            \
  INTRINSIC(void) put_ms(TYPE val) { __builtin_aie2ps_put_ms((int)val, 0); }   \
  INTRINSIC(void) put_ms(TYPE val, int en, int tlast) { put_ms(val, tlast); }  \
  INTRINSIC(void) put_ms_nb(TYPE val, int tlast, bool &success) {              \
    int suc;                                                                   \
    __builtin_aie2ps_put_ms_nb((int)val, tlast, suc);                          \
    success = suc;                                                             \
  }                                                                            \
  INTRINSIC(void) put_ms_nb(TYPE val, bool &success) {                         \
    int suc;                                                                   \
    __builtin_aie2ps_put_ms_nb((int)val, 0, suc);                              \
    success = suc;                                                             \
  }
PUT_MS(int)
PUT_MS(unsigned int);
...
GET_SS(v2float16, get, _v2float16)
...
GET_SS_32(v32float)
GET_SS_32(v64float16)

#endif // __AIE2PS_STREAMS_H__
