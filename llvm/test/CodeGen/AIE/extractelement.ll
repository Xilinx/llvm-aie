...
; AIE2-NEXT:    mova r16, #0 // Delay Slot 4
...
; AIE2:         .p2align 4
; AIE2-NEXT:  // %bb.0:
; AIE2-NEXT:    nopa ; nopx ; mov r5, r16
...
; AIE2-NEXT:    vextract.s32 r0, x0, r16 // Delay Slot 3
; AIE2-NEXT:    nop // Delay Slot 2
; AIE2-NEXT:    mov r16, r5 // Delay Slot 1
;
...
; AIE2-NEXT:    mova r0, #64; movx r2, #0
...
; AIE2P:         .p2align 4
; AIE2P-NEXT:  // %bb.0:
; AIE2P-NEXT:    mova r0, #64; nopb ; nops ; movx r2, #0; nopm ; nopv
...
; AIE2-NEXT:  // %bb.0:
; AIE2-NEXT:    nopx ; mov r3, r16
; AIE2-NEXT:    mova r0, #32; movx r2, #0
; AIE2-NEXT:    lt r27, r1, r0
; AIE2-NEXT:    add r16, r27, #-1
; AIE2-NEXT:    sel.nez r0, r2, r0, r27
; AIE2-NEXT:    ret lr
...
; AIE2P:         .p2align 4
; AIE2P-NEXT:  // %bb.0:
; AIE2P-NEXT:    mova r0, #32; nopb ; nops ; movx r2, #0; nopm ; nopv
; AIE2P-NEXT:    nopa ; lt r27, r1, r0
; AIE2P-NEXT:    add r16, r27, #-1
; AIE2P-NEXT:    ret lr
; AIE2P-NEXT:    sel.nez r0, r2, r0, r27 // Delay Slot 5
