...
; CHECK-NEXT:    vextract.8 r0, x0, #0, vaddsign1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r1, x0, #1, vaddsign1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r2, x0, #2, vaddsign1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r3, x0, #3, vaddsign1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r4, x0, #4, vaddsign1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r5, x0, #5, vaddsign1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r6, x0, #6, vaddsign1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r7, x0, #7, vaddsign1
; CHECK-NEXT:    nop
; CHECK-NEXT:    mova dj0, #8
; CHECK-NEXT:    st.s8 r16, [p2, dj0]
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r16, x0, #8, vaddsign1
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r17, x0, #9, vaddsign1
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r18, x0, #10, vaddsign1
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r21, x0, #13, vaddsign1
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r22, x0, #14, vaddsign1
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vextract.8 r23, x0, #15, vaddsign1
...
; CHECK-NEXT:    lda.s8 r20, [p2, dj5]
; CHECK-NEXT:    mova dj5, #13
; CHECK-NEXT:    lda.s8 r21, [p2, dj5]
...
; CHECK-NEXT:    lda.s8 r2, [p2, #2]
; CHECK-NEXT:    lda.s8 r3, [p2, #3]
; CHECK-NEXT:    st.s8 r1, [p4], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r16, [p3, dj5]
; CHECK-NEXT:    st.s8 r17, [p4], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r17, [p3, dj5]
; CHECK-NEXT:    st.s8 r18, [p4], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r18, [p3, dj5]
; CHECK-NEXT:    st.s8 r19, [p4], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r19, [p3, dj5]
; CHECK-NEXT:    st.s8 r20, [p4], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r20, [p3, dj5]
; CHECK-NEXT:    st.s8 r21, [p4], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r21, [p3, dj5]
; CHECK-NEXT:    st.s8 r22, [p4, #0]
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r22, [p3, dj5]
; CHECK-NEXT:    st.s8 r23, [p4, #1]
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r23, [p3, dj5]
; CHECK-NEXT:    st.s16 r0, [p6], #2
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda r8, [sp, #-564] // 4-byte Folded Reload
; CHECK-NEXT:    st.s16 r22, [p6, #0]
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    st r0, [p0], #4
; CHECK-NEXT:    lda r0, [p5, #4]
; CHECK-NEXT:    st r1, [p0], #4
; CHECK-NEXT:    lda r1, [p5, #8]
; CHECK-NEXT:    st r2, [p0], #4
; CHECK-NEXT:    lda r2, [p5, #16]
; CHECK-NEXT:    st r3, [p0], #4
; CHECK-NEXT:    lda r3, [p5, #24]
; CHECK-NEXT:    st r4, [p0], #4
; CHECK-NEXT:    lda r4, [p5, dj4]
; CHECK-NEXT:    st r5, [p0], #4
; CHECK-NEXT:    lda r5, [p5, dj6]
; CHECK-NEXT:    st r6, [p0, #0]
; CHECK-NEXT:    st r7, [p0, #4]
; CHECK-NEXT:    mov p0, r9
; CHECK-NEXT:    lda r6, [p5, dj1]
; CHECK-NEXT:    lda r7, [p5, dj0]
; CHECK-NEXT:    lda r16, [p5], #12
; CHECK-NEXT:    lda r9, [sp, #-568] // 4-byte Folded Reload
; CHECK-NEXT:    lda r17, [p5], #8
; CHECK-NEXT:    lda r18, [p5], #8
; CHECK-NEXT:    lda r19, [p5], #8
; CHECK-NEXT:    lda r20, [p5], #8
; CHECK-NEXT:    lda r21, [p5], #8
; CHECK-NEXT:    lda r22, [p5, #0]
; CHECK-NEXT:    lda r23, [p5, #8]
; CHECK-NEXT:    st r16, [p0], #4
; CHECK-NEXT:    lda r16, [p7, dj4]
...
; CHECK-NEXT:    lda r17, [p7, dj4]
; CHECK-NEXT:    st r2, [p0], #4
; CHECK-NEXT:    lda r2, [p7, #8]
; CHECK-NEXT:    st r18, [p0], #4
; CHECK-NEXT:    lda r18, [p7, dj6]
; CHECK-NEXT:    st r3, [p0], #4
; CHECK-NEXT:    lda r3, [p7, #12]
; CHECK-NEXT:    st r19, [p0], #4
; CHECK-NEXT:    lda r19, [p7, dj7]
; CHECK-NEXT:    st r4, [p0], #4
; CHECK-NEXT:    lda r4, [p7, #16]
; CHECK-NEXT:    st r20, [p0], #4
; CHECK-NEXT:    lda r20, [p7, dj1]
; CHECK-NEXT:    st r5, [p0], #4
; CHECK-NEXT:    lda r5, [p7, #20]
; CHECK-NEXT:    st r21, [p0], #4
; CHECK-NEXT:    lda r21, [p7, dj3]
; CHECK-NEXT:    st r6, [p0], #4
; CHECK-NEXT:    lda r6, [p7, #24]
; CHECK-NEXT:    st r22, [p0], #4
; CHECK-NEXT:    lda r22, [p7, dj0]
; CHECK-NEXT:    st r7, [p0, #0]
; CHECK-NEXT:    st r23, [p0, #4]
; CHECK-NEXT:    mov p0, r24
; CHECK-NEXT:    lda r7, [p7, #28]
; CHECK-NEXT:    lda r23, [p7, dj2]
