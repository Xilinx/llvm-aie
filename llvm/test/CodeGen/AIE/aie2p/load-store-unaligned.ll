...
; CHECK-NEXT:    st p0, [sp, #-44] // 4-byte Folded Spill
; CHECK-NEXT:    mov p0, sp
; CHECK-NEXT:    padda [p6], m0
; CHECK-NEXT:    mova m0, #-112
; CHECK-NEXT:    padda [p0], m0
; CHECK-NEXT:    st p0, [sp, #-48] // 4-byte Folded Spill
...
; CHECK-NEXT:    st r16, [p1, #0]
; CHECK-NEXT:    mov p1, p0
; CHECK-NEXT:    vextract.64 r21:r20, x0, #3, vaddsign1
; CHECK-NEXT:    vmov x0, bmll1
; CHECK-NEXT:    st r17, [p0, #12]
...
; CHECK-NEXT:    st r4, [p0, dj6]
; CHECK-NEXT:    st r5, [p0, dj7]
...
; CHECK-NEXT:    lda.s16 r16, [p4, dj5]
; CHECK-NEXT:    st.s8 r17, [p3], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r17, [p4, dj5]
; CHECK-NEXT:    st.s8 r18, [p3], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r18, [p4, dj5]
; CHECK-NEXT:    st.s8 r19, [p3], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r19, [p4, dj5]
; CHECK-NEXT:    st.s8 r20, [p3], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r20, [p4, dj5]
; CHECK-NEXT:    st.s8 r21, [p3], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r21, [p4, dj5]
; CHECK-NEXT:    st.s8 r22, [p3], #1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s16 r22, [p4, dj5]
; CHECK-NEXT:    st.s8 r23, [p3, #0]
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    st r22, [p0], #4 // Delay Slot 3
; CHECK-NEXT:    st r23, [p0, #0] // Delay Slot 2
