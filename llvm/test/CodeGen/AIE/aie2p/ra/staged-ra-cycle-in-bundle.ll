...
; FINE-GRAINED-NEXT:    nopa ; nopb ; nops ; nopx ; mov r17, dc6; nopv
; FINE-GRAINED-NEXT:    or r6, r5, r5; mov r5, dj4
; FINE-GRAINED-NEXT:    mov dj6, r9
; FINE-GRAINED-NEXT:    movs dc6, r4; mov dj2, r9
; FINE-GRAINED-NEXT:    movs m2, m4; mov dn2, r3
; FINE-GRAINED-NEXT:    movs m1, m5; mov dn6, r3
; FINE-GRAINED-NEXT:    movs dj1, m5; mov dn1, r3
; FINE-GRAINED-NEXT:    mova p1, #0; movs dc1, dc0; mov dn5, r3
; FINE-GRAINED-NEXT:    mova p0, #0; movs dj5, m5; or r25, r18, r18; vmov lfl1, lfl0
; FINE-GRAINED-NEXT:    padds.3d [p0], d1; vldb.pop.576.3d ex0, [p1, lf1, r25, d2]; vmov lfh1, lfh0
...
; FINE-GRAINED-NEXT:    movs dj6, r2; or r25, r18, r18; mov p1, p0
