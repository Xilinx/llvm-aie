...
; CHECK:         .p2align 4
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    nopa ; vldb.4x16.lo wl0, wl2; nops ; nopxm ; nopv
...
; CHECK-NEXT:    nop // Delay Slot 1
  %2 = tail call <8 x i32> @llvm.aie2p.load.4x16.lo(<8 x i32> %0)
  ret <8 x i32> %2
}
...
; CHECK:         .p2align 4
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    nopa ; vldb.4x16.hi wl0, wl2; nops ; nopxm ; nopv
; CHECK-NEXT:    nopa ; ret lr
; CHECK-NEXT:    nop // Delay Slot 5
; CHECK-NEXT:    nop // Delay Slot 4
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    nop // Delay Slot 1
  %2 = tail call <8 x i32> @llvm.aie2p.load.4x16.hi(<8 x i32> %0)
  ret <8 x i32> %2
}
...
; CHECK:         .p2align 4
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    nopa ; vldb.4x32.lo wl0, wl2; nops ; nopxm ; nopv
; CHECK-NEXT:    nopa ; ret lr
; CHECK-NEXT:    nop // Delay Slot 5
; CHECK-NEXT:    nop // Delay Slot 4
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    nop // Delay Slot 1
  %2 = tail call <8 x i32> @llvm.aie2p.load.4x32.lo(<8 x i32> %0)
  ret <8 x i32> %2
}
...
; CHECK:         .p2align 4
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    nopa ; vldb.4x32.hi wl0, wl2; nops ; nopxm ; nopv
; CHECK-NEXT:    nopa ; ret lr
; CHECK-NEXT:    nop // Delay Slot 5
; CHECK-NEXT:    nop // Delay Slot 4
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    nop // Delay Slot 1
  %2 = tail call <8 x i32> @llvm.aie2p.load.4x32.hi(<8 x i32> %0)
  ret <8 x i32> %2
}
...
; CHECK:         .p2align 4
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    nopa ; vldb.4x64.lo wl0, wl2; nops ; nopxm ; nopv
; CHECK-NEXT:    nopa ; ret lr
; CHECK-NEXT:    nop // Delay Slot 5
; CHECK-NEXT:    nop // Delay Slot 4
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    nop // Delay Slot 1
  %2 = tail call <8 x i32> @llvm.aie2p.load.4x64.lo(<8 x i32> %0)
  ret <8 x i32> %2
}
...
; CHECK:         .p2align 4
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    nopa ; vldb.4x64.hi wl0, wl2; nops ; nopxm ; nopv
; CHECK-NEXT:    nopa ; ret lr
; CHECK-NEXT:    nop // Delay Slot 5
; CHECK-NEXT:    nop // Delay Slot 4
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    nop // Delay Slot 1
  %2 = tail call <8 x i32> @llvm.aie2p.load.4x64.hi(<8 x i32> %0)
  ret <8 x i32> %2
}

; Function Attrs: mustprogress nocallback nofree nosync nounwind willreturn memory(read)
declare <8 x i32> @llvm.aie2p.load.4x64.lo(<8 x i32>) #1

; Function Attrs: mustprogress nocallback nofree nosync nounwind willreturn memory(read)
declare <8 x i32> @llvm.aie2p.load.4x64.hi(<8 x i32>) #1

; Function Attrs: mustprogress nocallback nofree nosync nounwind willreturn memory(read)
declare <8 x i32> @llvm.aie2p.load.4x32.lo(<8 x i32>) #1

; Function Attrs: mustprogress nocallback nofree nosync nounwind willreturn memory(read)
declare <8 x i32> @llvm.aie2p.load.4x32.hi(<8 x i32>) #1

; Function Attrs: mustprogress nocallback nofree nosync nounwind willreturn memory(read)
declare <8 x i32> @llvm.aie2p.load.4x16.lo(<8 x i32>) #1

; Function Attrs: mustprogress nocallback nofree nosync nounwind willreturn memory(read)
declare <8 x i32> @llvm.aie2p.load.4x16.hi(<8 x i32>) #1
