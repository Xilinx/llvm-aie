...
; CHECK:   %v0.steady.phi = phi i32 [ %v0.steady.peel, %steady.stage0.top ], [ %v0.steady.epi, %steady.stage1.bottom_and_stage0.top ]
; CHECK:   %v1.steady.phi = phi i32 [ %v1.steady.peel, %steady.stage0.top ], [ %v1.steady.epi, %steady.stage1.bottom_and_stage0.top ]
...
; The peel block (steady.stage0.top) must NOT appear inside this
