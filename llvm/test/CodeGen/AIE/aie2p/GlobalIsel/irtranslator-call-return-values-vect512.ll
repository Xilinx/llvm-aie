...
define void @call_v16int32() {
  ...
  ; CHECK-NEXT:   PseudoJL @callee_v16int32, csr_aie2p, implicit-def $lr, implicit-def $x0
...
define void @call_v32int16() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoJL @callee_v32int16, csr_aie2p, implicit-def $lr, implicit-def $x0
...
define void @call_v64int8() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoJL @callee_v64int8, csr_aie2p, implicit-def $lr, implicit-def $x0
...
define void @call_v16float() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoJL @callee_v16float, csr_aie2p, implicit-def $lr, implicit-def $x0
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(<16 x s32>) = COPY $x0
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
