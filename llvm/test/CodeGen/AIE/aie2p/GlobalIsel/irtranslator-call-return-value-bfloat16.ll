...
define dso_local void @_Z17test_get_bfloat16v() local_unnamed_addr #0 {
  ...
  ; CHECK-NEXT:   PseudoJL @_Z12ret_vfloat16v, csr_aie2p, implicit-def $lr, implicit-def $r0
...
define dso_local void @_Z19test_get_v2bfloat16v() local_unnamed_addr #0 {
  ...
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoJL @_Z15test_v2bfloat16v, csr_aie2p, implicit-def $lr, implicit-def $r0
...
define dso_local void @_Z19test_get_v4bfloat16v() local_unnamed_addr #0 {
  ...
  ; CHECK-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %stack.0.ret
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoJL @_Z15test_v4bfloat16v, csr_aie2p, implicit-def $lr, implicit-def $l0
...
define void @_Z23test_call_retv8bfloat16v() #0 {
  ...
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoJL @_Z14ret_v8bfloat16v, csr_aie2p, implicit-def $lr, implicit-def $wl0
...
define void @_Z24test_call_retv16bfloat16v() #0 {
  ...
  ; CHECK-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %stack.0.call
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoJL @_Z15ret_v16bfloat16v, csr_aie2p, implicit-def $lr, implicit-def $wl0
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(<16 x s16>) = COPY $wl0
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
...
define void @_Z24test_call_retv32bfloat16v() #0 {
  ...
  ; CHECK-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %stack.0.call
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoJL @_Z15ret_v32bfloat16v, csr_aie2p, implicit-def $lr, implicit-def $x0
...
define void @_Z24test_call_retv64bfloat16v() #0 {
  ...
  ; CHECK-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %stack.0.call
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoJL @_Z15ret_v64bfloat16v, csr_aie2p, implicit-def $lr, implicit-def $y2
