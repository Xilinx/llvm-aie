...
define void @speculative_no_anchor(ptr %a, ptr %c, i32 %n, i32 %m) {
  ...
  ; CHECK-NEXT:   [[PHI1:%[0-9]+]]:_(p0) = G_PHI %18(p0), %bb.6, [[COPY1]](p0), %bb.3
  ; CHECK-NEXT:   [[PHI2:%[0-9]+]]:_(s32) = G_PHI [[LOAD]](s32), %bb.3, %22(s32), %bb.6
  ; CHECK-NEXT:   [[PHI3:%[0-9]+]]:_(p0) = G_PHI [[PTR_ADD]](p0), %bb.3, %24(p0), %bb.6
  ; CHECK-NEXT:   [[PHI4:%[0-9]+]]:_(s32) = G_PHI [[INT]](s32), %bb.3, %25(s32), %bb.6
  ...
  ; CHECK-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p0) = nuw nusw G_PTR_ADD [[PHI1]], [[C3]](s20)
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.5.steady.stage1.inner.inner.header:
  ; CHECK-NEXT:   successors: %bb.5(0x7c000000), %bb.6(0x04000000)
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[PHI5:%[0-9]+]]:_(s32) = G_PHI [[C1]](s32), %bb.4, %20(s32), %bb.5
  ; CHECK-NEXT:   [[ADD:%[0-9]+]]:_(s32) = G_ADD [[PHI5]], [[PHI2]]
  ...
  ; CHECK-NEXT:   [[LOAD1:%[0-9]+]]:_(s32) = G_LOAD [[PHI3]](p0) :: (load (s32) from %ir.a.ptr.next.steady.phi)
  ; CHECK-NEXT:   [[C4:%[0-9]+]]:_(s20) = G_CONSTANT i20 4
  ; CHECK-NEXT:   [[PTR_ADD2:%[0-9]+]]:_(p0) = nuw nusw G_PTR_ADD [[PHI3]], [[C4]](s20)
  ; CHECK-NEXT:   [[INT2:%[0-9]+]]:_(s32) = G_INTRINSIC_W_SIDE_EFFECTS intrinsic(@llvm.loop.decrement.reg), [[PHI4]](s32), [[C]](s32)
