...
; CHECK-NEXT:   - II:              '1'
; CHECK-NEXT:   - NS:              '1'
; CHECK-NEXT:   - Loop:            bb.3.steady.inner.header
; CHECK-NEXT:   - Prologue:        bb.2.steady.header
; CHECK-NEXT:   - PrologueBundles: '9'
; CHECK-NEXT:   - Epilogue:        bb.4.steady.latch
...
; CHECK-NEXT:   - II:              '1'
; CHECK-NEXT:   - NS:              '1'
; CHECK-NEXT:   - Loop:            bb.6.steady.inner.header.lastiter
; CHECK-NEXT:   - Prologue:        bb.5.lastiter.prologue
; CHECK-NEXT:   - PrologueBundles: '9'
; CHECK-NEXT:   - Epilogue:        bb.7.lastiter.epilogue
