...
; CHECK-NEXT:    mova r0, #0; mov r31, r1 // Delay Slot 4
; CHECK-NEXT:    divs r0, r31, r0, r2 // Delay Slot 3
; CHECK-NEXT:    mov r0, r31 // Delay Slot 2
; CHECK-NEXT:    nop // Delay Slot 1
entry:
  %0 = tail call { i32, i32 } @llvm.aie2p.divs(i32 %a, i32 0, i32 %b)
...
; CHECK-NEXT:    mova r0, #0; mov r31, r1 // Delay Slot 3
...
declare { i32, i32 } @llvm.aie2p.divs(i32, i32, i32) #1
