...
; CHECK-NEXT:    st r4, [p0, #0] // Delay Slot 3
; CHECK-NEXT:    st r5, [p0, #4] // Delay Slot 2
...
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    mova m0, #-8; nopb ; nops ; movxm p0, ##(buffer2+8); nopv
; CHECK-NEXT:    padda [p0], m0; nopb ; nopxm
; CHECK-NEXT:    lda r0, [p0], #4
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    lda.s8 r0, [p0, #4]; st r0, [p1], #4
; CHECK-NEXT:    st.s8 r0, [p1, #4]
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nopa ; vldb.128 wh0, [p0, #0]; nopx
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    ret lr
; CHECK-NEXT:    nop // Delay Slot 5
...
; CHECK-NEXT:    vst.128 wh0, [p0, #0] // Delay Slot 2
; CHECK-NEXT:    nop // Delay Slot 1
entry:
...
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    movxm p0, ##buffer2
; CHECK-NEXT:    vldb.128 wh0, [p0], #16; nopx
; CHECK-NEXT:    vldb.128 wh2, [p0, #0]
; CHECK-NEXT:    lda r0, [p0, #16]
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    ret lr
; CHECK-NEXT:    movxm p0, ##buffer1 // Delay Slot 5
; CHECK-NEXT:    vst.128 wh0, [p0], #16 // Delay Slot 4
; CHECK-NEXT:    vst.128 wh2, [p0, #0] // Delay Slot 3
; CHECK-NEXT:    st r0, [p0, #16] // Delay Slot 2
; CHECK-NEXT:    nop // Delay Slot 1
entry:
...
; CHECK-NEXT:    st r2, [p0, #0] // Delay Slot 3
; CHECK-NEXT:    st r3, [p0, #4] // Delay Slot 2
; CHECK-NEXT:    nop // Delay Slot 1
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: none, inaccessiblemem: none)
define dso_local void @lowerMemcpyUsingWordVector64() local_unnamed_addr #0 {
; CHECK-LABEL: lowerMemcpyUsingWordVector64:
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    nopa ; nopb ; movxm p0, ##buffer2
; CHECK-NEXT:    vldb x0, [p0], #64
; CHECK-NEXT:    lda r0, [p0], #4
; CHECK-NEXT:    lda r1, [p0], #4
; CHECK-NEXT:    lda r2, [p0, #0]
; CHECK-NEXT:    lda r3, [p0, #4]
...
; CHECK-NEXT:    nop // Delay Slot 1
entry:
  tail call void @llvm.memcpy.p0.p0.i32(ptr noundef nonnull align 64 dereferenceable(80) @buffer1, ptr noundef nonnull align 64 dereferenceable(80) @buffer2, i32 80, i1 false)
  ret void
}
...
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    mova r0, #0; nopb ; nops ; movxm p0, ##(buffer1+4); nopv
