...
; CHECK-NEXT:    nopa ; vldb.fill.512 [p0, lf0, r24]; nopx ; vst.push.576.conv.bfp16ebs8.fp32 dm0, [p2, sf, r26]
; CHECK-NEXT:    vldb.pop.512 x0, [p0, lf0, r24]; vst.flush.512.conv [p2, sf, r26]
; CHECK-NEXT:    vldb.pop.512.2d x2, [p0, lf0, r24, d1]; vst.flush.512.conv.2d [p2, sf, r26, d0]
