...
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    nops ; mov crunpacksize, #1
; CHECK-NEXT:    movxm ls, #.LBB0_1
; CHECK-NEXT:    mova p0, #0; movxm le, #.L_LEnd0
; CHECK-NEXT:    mova r1, #1; vldb.unpack x3, unpacksign0, [p0, #0]; mov crsrsmode, #0
...
; CHECK-NEXT:    nopa ; vldb.unpack x3, unpacksign0, [p0, #0]; nops ; nopx ; vmov x7, x2; nopv
; CHECK-NEXT:    nopa ; nopb ; nops ; nopx ; vmov x6, x2; nopv
; CHECK-NEXT:    nopx ; vmin_ge.16 x9, r16, x3, x0, vaddsign0
...
; CHECK-NEXT:    vsrs.4x wh11, cml4, s0, srssign0; ret lr
; CHECK-NEXT:    nop // Delay Slot 5
; CHECK-NEXT:    nop // Delay Slot 4
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    vsrs.4x wh11, cml4, s0, srssign0 // Delay Slot 1
entry:
  br label %for.body
