...
; RUN: llc --march=aie2ps --stop-after=prologepilog -frame-pointer=all %s -o -| FileCheck %s --check-prefix=AIE2PS
...
define i32 @test_call_external(i32 %a) nounwind {
  ...
  ; AIE2PS-NEXT:   ST_dms_sts_scalar_spill killed $p7, -60, implicit $sp :: (store (s32) into %stack.1)
  ...
  ; AIE2PS-NEXT:   $p7 = LDA_dms_lda_scalar_spill -60, implicit $sp :: (load (s32) from %stack.1)
...
define i32 @defined_function(i32 %a) nounwind {
  ; AIE2-LABEL: name: defined_function
  ; AIE2: bb.0 (%ir-block.0):
  ; AIE2-NEXT:   liveins: $r1
  ; AIE2-NEXT: {{  $}}
  ; AIE2-NEXT:   frame-setup PADD_sp_imm_pseudo 32, implicit-def $sp, implicit $sp
  ; AIE2-NEXT:   ST_dms_spill killed $p7, -32, implicit $sp :: (store (s32) into %stack.0)
  ; AIE2-NEXT:   $p7 = frame-setup MOV_mv_scl $sp
  ; AIE2-NEXT:   $p7 = frame-setup PADD_imm10_pseudo $p7, -32
  ; AIE2-NEXT:   renamable $r0 = ADD_add_r_ri killed renamable $r1, 1, implicit-def dead $srcarry
  ; AIE2-NEXT:   $p7 = LDA_dms_spill -32, implicit $sp :: (load (s32) from %stack.0)
  ; AIE2-NEXT:   frame-destroy PADD_sp_imm_pseudo -32, implicit-def $sp, implicit $sp
  ; AIE2-NEXT:   PseudoRET implicit $lr, implicit $r0
  ;
  ; AIE2P-LABEL: name: defined_function
  ; AIE2P: bb.0 (%ir-block.0):
  ; AIE2P-NEXT:   liveins: $r1
  ; AIE2P-NEXT: {{  $}}
  ; AIE2P-NEXT:   frame-setup PADDXM_pstm_sp_imm 64, implicit-def $sp, implicit $sp
  ; AIE2P-NEXT:   ST_dms_sts_spill killed $p7, -64, implicit $sp :: (store (s32) into %stack.0)
  ; AIE2P-NEXT:   $p7 = frame-setup MOV_alu_mv_mv_mv_scl $sp
  ; AIE2P-NEXT:   $p7 = frame-setup PADD_imm_pseudo $p7, -64
  ; AIE2P-NEXT:   renamable $r0 = ADD_add_r_ri killed renamable $r1, 1, implicit-def dead $srcarry
  ; AIE2P-NEXT:   $p7 = LDA_dms_lda_spill -64, implicit $sp :: (load (s32) from %stack.0)
  ; AIE2P-NEXT:   frame-destroy PADDXM_pstm_sp_imm -64, implicit-def $sp, implicit $sp
  ; AIE2P-NEXT:   PseudoRET implicit $lr, implicit $r0
  ;
  ; AIE2PS-LABEL: name: defined_function
  ; AIE2PS: bb.0 (%ir-block.0):
  ; AIE2PS-NEXT:   liveins: $r1
  ; AIE2PS-NEXT: {{  $}}
  ; AIE2PS-NEXT:   frame-setup PADDXM_pstm_sp_imm 64, implicit-def $sp, implicit $sp
  ; AIE2PS-NEXT:   ST_dms_sts_scalar_spill killed $p7, -64, implicit $sp :: (store (s32) into %stack.0)
  ; AIE2PS-NEXT:   $p7 = frame-setup MOV_alu_mv_mv_mv_scl $sp
  ; AIE2PS-NEXT:   $p7 = frame-setup PADD_imm_pseudo $p7, -64
  ; AIE2PS-NEXT:   renamable $r0 = ADD_add_r_ri killed renamable $r1, 1, implicit-def dead $srcarry
  ; AIE2PS-NEXT:   $p7 = LDA_dms_lda_scalar_spill -64, implicit $sp :: (load (s32) from %stack.0)
  ; AIE2PS-NEXT:   frame-destroy PADDXM_pstm_sp_imm -64, implicit-def $sp, implicit $sp
  ; AIE2PS-NEXT:   PseudoRET implicit $lr, implicit $r0
  %1 = add i32 %a, 1
  ret i32 %1
...
define i32 @test_call_fastcc(i32 %a, i32 %b) nounwind {
  ...
  ; AIE2PS-NEXT:   ST_dms_sts_scalar_spill killed $p7, -56, implicit $sp :: (store (s32) into %stack.2)
  ; AIE2PS-NEXT:   $p7 = frame-setup MOV_alu_mv_mv_mv_scl $sp
  ; AIE2PS-NEXT:   $p7 = frame-setup PADD_imm_pseudo $p7, -64
  ...
  ; AIE2PS-NEXT:   $p7 = LDA_dms_lda_scalar_spill -56, implicit $sp :: (load (s32) from %stack.2)
