...
define void @simple(ptr nocapture %out, ptr nocapture readonly %in, i32 noundef %size) {
  ...
  ; AIE2-NEXT:   [[C:%[0-9]+]]:_(s20) = G_CONSTANT i20 1
  ; AIE2-NEXT:   [[C1:%[0-9]+]]:_(s32) = G_CONSTANT i32 1
  ; AIE2-NEXT:   [[C2:%[0-9]+]]:_(s20) = G_CONSTANT i20 0
  ...
  ; AIE2-NEXT: {{  $}}
  ; AIE2-NEXT:   [[PHI:%[0-9]+]]:_(s20) = G_PHI %13(s20), %bb.3, [[C2]](s20), %bb.1
  ; AIE2-NEXT:   [[PHI1:%[0-9]+]]:_(s32) = G_PHI [[LOAD]](s32), %bb.1, %11(s32), %bb.3
  ; AIE2-NEXT:   [[C3:%[0-9]+]]:_(s20) = G_CONSTANT i20 4
  ; AIE2-NEXT:   [[MUL:%[0-9]+]]:_(s20) = G_MUL [[PHI]], [[C3]]
  ...
  ; AIE2-NEXT:   [[ADD1:%[0-9]+]]:_(s20) = G_ADD [[PHI]], [[C]]
  ; AIE2-NEXT:   [[INT:%[0-9]+]]:_(s1) = G_INTRINSIC_W_SIDE_EFFECTS intrinsic(@llvm.loop.decrement), [[C1]](s32)
  ...
  ; AIE2p-NEXT:   [[C:%[0-9]+]]:_(s20) = G_CONSTANT i20 1
  ; AIE2p-NEXT:   [[C1:%[0-9]+]]:_(s32) = G_CONSTANT i32 1
  ; AIE2p-NEXT:   [[C2:%[0-9]+]]:_(s20) = G_CONSTANT i20 0
  ...
  ; AIE2p-NEXT: {{  $}}
  ; AIE2p-NEXT:   [[PHI:%[0-9]+]]:_(s20) = G_PHI %13(s20), %bb.3, [[C2]](s20), %bb.1
  ; AIE2p-NEXT:   [[PHI1:%[0-9]+]]:_(s32) = G_PHI [[LOAD]](s32), %bb.1, %11(s32), %bb.3
  ; AIE2p-NEXT:   [[C3:%[0-9]+]]:_(s20) = G_CONSTANT i20 4
  ; AIE2p-NEXT:   [[MUL:%[0-9]+]]:_(s20) = G_MUL [[PHI]], [[C3]]
  ...
  ; AIE2p-NEXT:   [[ADD1:%[0-9]+]]:_(s20) = G_ADD [[PHI]], [[C]]
  ; AIE2p-NEXT:   [[INT:%[0-9]+]]:_(s1) = G_INTRINSIC_W_SIDE_EFFECTS intrinsic(@llvm.loop.decrement), [[C1]](s32)
