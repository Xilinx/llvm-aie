...
; AIE2-NEXT:    nopb ; mova r1, #1; nops ; movxm le, #.L_LEnd0; nopv
...
; AIE2P-NEXT:    mova r1, #1; nopb ; nops ; movxm le, #.L_LEnd0; nopv
...
; AIE2PS-NEXT:    mova r2, #1; nopb ; nops ; movxm le, #.L_LEnd0; nopv
