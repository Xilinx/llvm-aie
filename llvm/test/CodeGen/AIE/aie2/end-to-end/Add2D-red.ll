...
; ASM-NEXT:    lda r3, [p0], #36
; ASM-NEXT:    lda r2, [p0], #-32
; ASM-NEXT:    lda r0, [p0], #-12; mov p6, sp
; ASM-NEXT:    lda r1, [p0], #40; paddb [p6], #-44
...
; ASM-NEXT:    lda dn4, [p0], #-8; st r1, [p4, #0]
; ASM-NEXT:    lda dj4, [p0], #-36; nez r4, r0; mov p4, sp
; ASM-NEXT:    lda r0, [p0], #-36; paddb [p4], #-48; st r4, [p5, #0]
; ASM-NEXT:    lda p4, [p4, #0]; mov p5, r5
; ASM-NEXT:    lda r5, [p0, #0]; mov p0, sp
; ASM-NEXT:    st m1, [p5, #0]
; ASM-NEXT:    mov p5, sp
; ASM-NEXT:    st m0, [p7, #0]
; ASM-NEXT:    paddb [p5], #-52; mov p7, sp
; ASM-NEXT:    lda p5, [p5, #0]; st dj0, [p6, #0]
; ASM-NEXT:    paddb [p7], #-56; mov p6, sp
; ASM-NEXT:    lda r6, [p7, #0]; paddb [p6], #-60; mov p7, sp
; ASM-NEXT:    lda r7, [p6, #0]; paddb [p7], #-64; mov p6, sp
; ASM-NEXT:    lda p7, [p7, #0]; paddb [p6], #-68; st dj4, [p4, #0]
; ASM-NEXT:    lda r8, [p6, #0]; mov p4, sp
; ASM-NEXT:    paddb [p4], #-76
; ASM-NEXT:    lda r11, [p4, #0]; mov p4, sp
; ASM-NEXT:    st dn0, [p5, #0]
; ASM-NEXT:    mov p5, r6
; ASM-NEXT:    paddb [p4], #-80; st dn4, [p5, #0]
; ASM-NEXT:    lda p6, [p4, #0]; mov p5, r7
; ASM-NEXT:    mova r6, #1; nez r0, r0; mov p4, sp
; ASM-NEXT:    st r0, [p5, #0]; ne r3, r3, r6
; ASM-NEXT:    mova r6, #3; paddb [p0], #-72; add r7, r2, #-1; st r5, [p7, #0]
; ASM-NEXT:    lda p0, [p0, #0]; paddb [p4], #-84; and r8, r2, r6; mov p7, r8
; ASM-NEXT:    lda r9, [p4, #0]; ltu r6, r7, r6; mov p4, sp
; ASM-NEXT:    paddb [p4], #-88; jz r6, #.LBB0_2
; ASM-NEXT:    lda r10, [p4, #0]; mov p4, sp // Delay Slot 5
; ASM-NEXT:    paddb [p4], #-92 // Delay Slot 4
; ASM-NEXT:    lda p4, [p4, #0]; paddb [p2], m3 // Delay Slot 3
; ASM-NEXT:    paddb [p2], m5; st r3, [p7, #0] // Delay Slot 2
; ASM-NEXT:    padda [p1], m2; paddb [p2], m4; st r8, [p0, #0]; mov dc0, #0 // Delay Slot 1
; ASM-NEXT:  // %bb.1:
...
; ASM-NEXT:    mov dc4, dc0 // Delay Slot 1
; ASM-NEXT:    .p2align 4
; ASM-NEXT:  .LBB0_2: // %entry.new
; ASM-NEXT:    nopb ; vlda.ups.s32.d8 cm0, s1, [p1], m1; nops ; nopx ; mov dc4, dc0; nopv
; ASM-NEXT:    vlda.3d.ups.s32.d8 cm2, s1, [p2], d0; nopx
; ASM-NEXT:    vlda.ups.s32.d8 cm1, s1, [p1], m1
; ASM-NEXT:    vlda.3d.ups.s32.d8 cm6, s1, [p2], d0
; ASM-NEXT:    vlda.ups.s32.d8 cm3, s1, [p1], m1; mov crUPSSign, r4
; ASM-NEXT:    vlda.3d.ups.s32.d8 cm7, s1, [p2], d0; mov s1, r1
...
; ASM-NEXT:    lshl r2, r2, r6; mov crSRSSign, r3
...
; ASM-NEXT:  // %bb.4:
; ASM-NEXT:    nopx ; vadd cm0, cm2, cm0, r0
...
; ASM-NEXT:    lda p7, [sp, #-32]; st dc4, [p4, #0] // 4-byte Folded Reload
; ASM-NEXT:    lda p6, [sp, #-28]; st dc0, [p0, #0] // 4-byte Folded Reload
