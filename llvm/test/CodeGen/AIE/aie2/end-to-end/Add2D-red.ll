...
; ASM-NEXT:    nopb ; vlda.ups.s32.d8 cm0, s1, [p1], m1; nops ; nopxm ; vadd cm2, cm6, cm1, r1
; ASM-NEXT:    nopb ; vlda.ups.s32.d8 cm1, s1, [p1], m1; nops ; nopxm ; vadd cm6, cm7, cm3, r1
; ASM-NEXT:    nopb ; vlda.ups.s32.d8 cm3, s1, [p1], m1; nops ; nopxm ; vadd cm4, cm5, cm4, r1
...
; ASM-NEXT:  // %bb.4:
; ASM-NEXT:    nopb ; nopa ; nops ; nopxm ; vadd cm0, cm2, cm0, r1
; ASM-NEXT:    vadd cm2, cm7, cm3, r1
