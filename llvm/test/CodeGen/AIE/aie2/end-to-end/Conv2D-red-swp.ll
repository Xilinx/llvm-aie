...
; DCL-NEXT:    nopb ; nopa ; nops ; nopx ; mov r29, r16; nopv
; DCL-NEXT:    mova dj3, #0
; DCL-NEXT:    mov s0, r0
; DCL-NEXT:    mov s1, r1
; DCL-NEXT:    mov s2, r6
...
; DCL-NEXT:    lda p7, [sp, #-192]; nopb ; nopx // 4-byte Folded Reload
...
; ZOL-NEXT:    nopb ; nopa ; nops ; nopx ; mov r28, r16; nopv
; ZOL-NEXT:    mova dj3, #0
; ZOL-NEXT:    mov s0, r0
; ZOL-NEXT:    mov s1, r1
; ZOL-NEXT:    mov s2, r6
...
; ZOL-NEXT:    lda p7, [sp, #-192]; nopb ; nopx // 4-byte Folded Reload
