...
; DCL-NEXT:    vlda.ups.s32.s16 bmh5, s0, [p2, #32]; vldb wh3, [p0], m6
; DCL-NEXT:    vlda.ups.s32.s16 bml5, s0, [p2], m7; vldb wl7, [p0], m6
; DCL-NEXT:    vlda.ups.s32.s16 bmh6, s0, [p2, #32]; vldb.3d wh7, [p0], d0
; DCL-NEXT:    vlda.ups.s32.s16 bml6, s0, [p2], m5
; DCL-NEXT:    vldb wl6, [p1], #32
; DCL-NEXT:    vldb wh6, [p1], #32
; DCL-NEXT:    vlda.ups.s32.s16 bmh7, s0, [p2, #32]; vldb wl5, [p0], m6; and r0, r0, r9; mov r1, p0
; DCL-NEXT:    vlda wl8, [p1], #32; vldb wh5, [p0], m6; add r0, r0, #33
; DCL-NEXT:    vlda wh8, [p1], #32; vldb wl3, [p0], m6; vshift.align x4, x4, s1, x3, r0
; DCL-NEXT:    vlda.ups.s32.s16 bml7, s0, [p2, #0]; vldb.3d wh3, [p0], d0; and r10, r1, r9; vshift.align x2, x2, s1, x7, r0
...
; ZOL-NEXT:    vlda.ups.s32.s16 bmh5, s0, [p2, #32]; vldb wh3, [p0], m6
; ZOL-NEXT:    vlda.ups.s32.s16 bml5, s0, [p2], m7; vldb wl7, [p0], m6
; ZOL-NEXT:    vlda.ups.s32.s16 bmh6, s0, [p2, #32]; vldb.3d wh7, [p0], d0
...
; ZOL-NEXT:    vlda.ups.s32.s16 bmh7, s0, [p2, #32]; vldb wh5, [p0], m6; and r0, r0, r9
; ZOL-NEXT:    vlda wl8, [p1], #32; vldb wl3, [p0], m6; add r0, r0, #33
; ZOL-NEXT:    vlda wh8, [p1], #32; vldb.3d wh3, [p0], d0; vshift.align x4, x4, s1, x3, r0
; ZOL-NEXT:    vlda.ups.s32.s16 bml7, s0, [p2, #0]; vldb wl1, [p1], #32; and r1, r1, r9; vshift.align x2, x2, s1, x7, r0
...
; ZOL-NEXT:    vldb wl5, [p0], m6; nopa ; nops ; nopx ; vshift.align x4, x4, s1, x5, r0; vmac cm5, cm5, x9, x8, r4
