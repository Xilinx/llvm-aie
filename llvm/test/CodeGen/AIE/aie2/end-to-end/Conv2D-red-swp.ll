...
; DCL-NEXT:    mov dc5, dj3
; DCL-NEXT:    mov dc2, dj3
; DCL-NEXT:    paddb [sp], #192; mov dc6, dj3
; DCL-NEXT:    st p7, [sp, #-192] // 4-byte Folded Spill
; DCL-NEXT:    mov p7, sp
; DCL-NEXT:    paddb [p7], #-272; st p6, [sp, #-188] // 4-byte Folded Spill
; DCL-NEXT:    lda r25, [p7, #0]; mov p6, sp
; DCL-NEXT:    paddb [p6], #-204; mov dc3, dj3
; DCL-NEXT:    lda m0, [p6, #0]; mov p6, sp
; DCL-NEXT:    paddb [p6], #-208; mov r28, dj3
; DCL-NEXT:    lda dj0, [p6, #0]; mov p6, sp
; DCL-NEXT:    paddb [p6], #-212; mov dc7, dj3
; DCL-NEXT:    lda dj4, [p6, #0]
; DCL-NEXT:    mov p6, sp
; DCL-NEXT:    paddb [p6], #-216
; DCL-NEXT:    lda dn0, [p6, #0]; mov p6, sp
; DCL-NEXT:    paddb [p6], #-220
; DCL-NEXT:    lda dn4, [p6, #0]; mov p6, sp
; DCL-NEXT:    paddb [p6], #-228
; DCL-NEXT:    lda r11, [p6, #0]; mov p6, sp
; DCL-NEXT:    paddb [p6], #-232; mov p7, sp
; DCL-NEXT:    lda dj1, [p6, #0]
; DCL-NEXT:    paddb [p7], #-200; mov p6, sp
; DCL-NEXT:    lda m6, [p7, #0]; paddb [p6], #-236
...
; DCL-NEXT:    lda dj2, [p6, #0]; st m2, [sp, #-96] // 4-byte Folded Spill
; DCL-NEXT:    mov p6, sp
; DCL-NEXT:    lda m7, [sp, #-96]; paddb [p6], #-256 // 4-byte Folded Reload
; DCL-NEXT:    lda dj6, [p6, #0]; mov p6, sp
; DCL-NEXT:    paddb [p6], #-260
; DCL-NEXT:    lda dn2, [p6, #0]; mov p6, sp
; DCL-NEXT:    paddb [p6], #-264; st dj2, [sp, #-88] // 4-byte Folded Spill
; DCL-NEXT:    lda dn6, [p6, #0]; mov p6, sp
; DCL-NEXT:    paddb [p6], #-268
; DCL-NEXT:    lda r14, [p6, #0]
; DCL-NEXT:    mov p6, sp
; DCL-NEXT:    lda dj7, [sp, #-88]; paddb [p6], #-276; st dn2, [sp, #-92] // 4-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    lda dn3, [p6, #0]; mov p6, sp
; DCL-NEXT:    paddb [p6], #-280
...
; DCL-NEXT:    lda r24, [p6, #0]; vst wl0, [sp, #-64] // 32-byte Folded Spill
; DCL-NEXT:    vst wh0, [sp, #-32]; mov p6, sp // 32-byte Folded Spill
; DCL-NEXT:    paddb [p6], #-284; st dc7, [sp, #-84] // 4-byte Folded Spill
; DCL-NEXT:    lda m4, [p6, #0]; st m7, [sp, #-96] // 4-byte Folded Spill
...
; DCL-NEXT:    vlda wl6, [p1], #32; nopb ; nopx
; DCL-NEXT:    vlda wl5, [p0], m6; mov r0, p0
; DCL-NEXT:    vlda.ups.s32.s16 bmh0, s0, [p2, #32]
; DCL-NEXT:    vlda wh6, [p1], #32
; DCL-NEXT:    vlda wh5, [p0], m6; mov m5, p4
; DCL-NEXT:    vlda.ups.s32.s16 bml0, s0, [p2], m5
; DCL-NEXT:    vlda wl8, [p1], #32
; DCL-NEXT:    vlda wl7, [p0], m6
; DCL-NEXT:    vlda.ups.s32.s16 bmh1, s0, [p2, #32]; mov m1, p5
; DCL-NEXT:    vlda.ups.s32.s16 bml1, s0, [p2], m1
; DCL-NEXT:    vlda wh8, [p1], #32
; DCL-NEXT:    vlda.3d wh7, [p0], d0
...
; DCL-NEXT:    vlda wl10, [p1], #32
; DCL-NEXT:    vlda wl3, [p0], m6; mov r1, p0
; DCL-NEXT:    vlda.ups.s32.s16 bml7, s0, [p2, #0]; and r0, r0, r9
; DCL-NEXT:    vlda wh3, [p0], m6; add r0, r0, #33
; DCL-NEXT:    vlda wl5, [p0], m6; vshift.align x4, x4, s1, x5, r0
; DCL-NEXT:    vlda.3d wh5, [p0], d0; and r10, r1, r9; vshift.align x2, x2, s1, x7, r0
; DCL-NEXT:    vlda wh10, [p1], #32; add r0, r10, #33; mov r10, p0
; DCL-NEXT:    vlda wl1, [p1], #32; add r1, r5, #-1; vshuffle x7, x4, x2, r2
; DCL-NEXT:    vlda wh1, [p1], #32; add r1, r1, #-1; vshuffle x9, x7, x0, r8
; DCL-NEXT:    and r10, r10, r9
; DCL-NEXT:    .p2align 4
...
; DCL-NEXT:    nopa ; nopb ; nopx ; vshift.align x4, x4, s1, x3, r0; vmac cm5, cm5, x9, x8, r4
; DCL-NEXT:    vlda wl3, [p0], m6; vshift.align x2, x2, s1, x5, r0
; DCL-NEXT:    vlda wh3, [p0], m6; vshuffle x11, x9, x0, r8
; DCL-NEXT:    vlda wl5, [p0], m6; add r1, r1, #-1; vshuffle x7, x4, x2, r2; vmac cm0, cm0, x7, x6, r4
; DCL-NEXT:    vlda wl10, [p1], #32; jnz r1, #.LBB0_2; vmac cm4, cm4, x7, x8, r4
; DCL-NEXT:    vlda.3d wh5, [p0], d0; vshuffle x9, x7, x0, r8; vmac cm2, cm2, x9, x6, r4 // Delay Slot 5
; DCL-NEXT:    vlda wh10, [p1], #32; vmov x6, x10; vmac cm6, cm6, x9, x8, r4 // Delay Slot 4
; DCL-NEXT:    vlda wl1, [p1], #32; vmov x8, x1; vmac cm3, cm3, x11, x6, r4 // Delay Slot 3
; DCL-NEXT:    vlda wh1, [p1], #32; add r0, r10, #33; mov r10, p0; vmac cm7, cm7, x11, x8, r4 // Delay Slot 2
; DCL-NEXT:    and r10, r10, r9 // Delay Slot 1
...
; DCL-NEXT:    lda dn7, [sp, #-92]; vmac cm5, cm6, x0, x8, r4 // 4-byte Folded Reload
; DCL-NEXT:    vmac cm4, cm5, x9, x8, r4
; DCL-NEXT:    lda dj7, [sp, #-88]; vshift.align x4, x4, s1, x3, r0; vmac cm8, cm4, x7, x8, r4 // 4-byte Folded Reload
; DCL-NEXT:    vshift.align x2, x2, s1, x5, r0; vmac cm3, cm3, x11, x6, r4
; DCL-NEXT:    vshuffle x6, x4, x2, r2
; DCL-NEXT:    vmac cm6, cm7, x6, x8, r4
; DCL-NEXT:    vshuffle x8, x6, x0, r8; vmac cm7, cm0, x6, x10, r4
; DCL-NEXT:    st dn7, [sp, #-92] // 4-byte Folded Spill
; DCL-NEXT:    vshuffle x3, x4, x2, r3; vmac cm0, cm1, x8, x10, r4
; DCL-NEXT:    st dj7, [sp, #-88] // 4-byte Folded Spill
; DCL-NEXT:    vshuffle x5, x3, x0, r8; vmac cm1, cm2, x3, x10, r4
; DCL-NEXT:    vst.srs.s16.s32 bmh7, s2, [p3, #32]; mov s3, r6
; DCL-NEXT:    vst.srs.s16.s32 bml7, s3, [p3], #64; vmac cm2, cm3, x5, x10, r4
...
; DCL-NEXT:    lda m7, [sp, #-96]; vst.srs.s16.s32 bml1, s3, [p3], #64; vmac cm8, cm4, x8, x1, r4 // 4-byte Folded Reload
...
; DCL-NEXT:    vst.srs.s16.s32 bmh3, s3, [p3, #32]; mov dj5, r12
; DCL-NEXT:    vst.srs.s16.s32 bml3, s3, [p3], #64; mov m2, r13; vmac cm4, cm6, x5, x1, r4
; DCL-NEXT:    vst.srs.s16.s32 bmh8, s3, [p3, #32]; mov m3, r14
...
; ZOL-NEXT:    mov dc5, dj3
; ZOL-NEXT:    mov dc2, dj3
; ZOL-NEXT:    paddb [sp], #192; mov dc6, dj3
; ZOL-NEXT:    st p7, [sp, #-192] // 4-byte Folded Spill
; ZOL-NEXT:    mov p7, sp
; ZOL-NEXT:    paddb [p7], #-272; st p6, [sp, #-188] // 4-byte Folded Spill
; ZOL-NEXT:    lda r24, [p7, #0]; mov p6, sp
; ZOL-NEXT:    paddb [p6], #-204; mov dc3, dj3
; ZOL-NEXT:    lda m0, [p6, #0]; mov p6, sp
; ZOL-NEXT:    paddb [p6], #-208; mov r27, dj3
; ZOL-NEXT:    lda dj0, [p6, #0]; mov p6, sp
; ZOL-NEXT:    paddb [p6], #-212; mov dc7, dj3
; ZOL-NEXT:    lda dj4, [p6, #0]
; ZOL-NEXT:    mov p6, sp
; ZOL-NEXT:    paddb [p6], #-216
; ZOL-NEXT:    lda dn0, [p6, #0]; mov p6, sp
; ZOL-NEXT:    paddb [p6], #-220
; ZOL-NEXT:    lda dn4, [p6, #0]; mov p6, sp
; ZOL-NEXT:    paddb [p6], #-228
; ZOL-NEXT:    lda r10, [p6, #0]; mov p6, sp
; ZOL-NEXT:    paddb [p6], #-232; mov p7, sp
; ZOL-NEXT:    lda dj1, [p6, #0]
; ZOL-NEXT:    paddb [p7], #-200; mov p6, sp
; ZOL-NEXT:    lda m6, [p7, #0]; paddb [p6], #-236
...
; ZOL-NEXT:    lda dj2, [p6, #0]; st m2, [sp, #-96] // 4-byte Folded Spill
; ZOL-NEXT:    mov p6, sp
; ZOL-NEXT:    lda m7, [sp, #-96]; paddb [p6], #-256 // 4-byte Folded Reload
; ZOL-NEXT:    lda dj6, [p6, #0]; mov p6, sp
; ZOL-NEXT:    paddb [p6], #-260
; ZOL-NEXT:    lda dn2, [p6, #0]; mov p6, sp
; ZOL-NEXT:    paddb [p6], #-264; st dj2, [sp, #-88] // 4-byte Folded Spill
; ZOL-NEXT:    lda dn6, [p6, #0]; mov p6, sp
; ZOL-NEXT:    paddb [p6], #-268
; ZOL-NEXT:    lda r13, [p6, #0]
; ZOL-NEXT:    mov p6, sp
; ZOL-NEXT:    lda dj7, [sp, #-88]; paddb [p6], #-276; st dn2, [sp, #-92] // 4-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    lda dn3, [p6, #0]; mov p6, sp
; ZOL-NEXT:    paddb [p6], #-280
...
; ZOL-NEXT:    lda r15, [p6, #0]; vst wl0, [sp, #-64] // 32-byte Folded Spill
; ZOL-NEXT:    vst wh0, [sp, #-32]; mov p6, sp // 32-byte Folded Spill
; ZOL-NEXT:    paddb [p6], #-284; st dc7, [sp, #-84] // 4-byte Folded Spill
; ZOL-NEXT:    lda m4, [p6, #0]; st m7, [sp, #-96] // 4-byte Folded Spill
...
; ZOL-NEXT:    vlda wh10, [p1], #32; movxm le, #.L_LEnd0
; ZOL-NEXT:    vlda.ups.s32.s16 bmh7, s0, [p2, #32]; mov lc, r1
; ZOL-NEXT:    nopb ; vlda wl3, [p0], m6; nops ; nopx ; mov r1, p0; nopv
; ZOL-NEXT:    nopb ; vlda wh3, [p0], m6; nops ; and r0, r0, r9; nopm ; nopv
; ZOL-NEXT:    nopb ; vlda wl5, [p0], m6; nops ; add r0, r0, #33; nopm ; nopv
; ZOL-NEXT:    nopb ; vlda.3d wh5, [p0], d0; nops ; nopx ; vshift.align x4, x4, s1, x3, r0; nopv
; ZOL-NEXT:    nopb ; vlda.ups.s32.s16 bml7, s0, [p2, #0]; nops ; nopx ; vshift.align x2, x2, s1, x5, r0; nopv
; ZOL-NEXT:    nopb ; vlda wl1, [p1], #32; nops ; and r1, r1, r9; vshuffle x7, x4, x2, r2; nopv
; ZOL-NEXT:    nopb ; vlda wh1, [p1], #32; nops ; add r0, r1, #33; mov r1, p0; nopv
; ZOL-NEXT:    nopa ; nopb ; nopx ; vshuffle x9, x7, x0, r8
...
; ZOL-NEXT:    vlda wl3, [p0], m6; nopx ; vshift.align x4, x4, s1, x3, r0; vmac cm5, cm5, x9, x8, r4
; ZOL-NEXT:    vlda wh3, [p0], m6; vshift.align x2, x2, s1, x5, r0
; ZOL-NEXT:    vlda wl5, [p0], m6; vshuffle x11, x9, x0, r8; vmac cm0, cm0, x7, x6, r4
; ZOL-NEXT:    vlda wl10, [p1], #32; vshuffle x7, x4, x2, r2; vmac cm4, cm4, x7, x8, r4
; ZOL-NEXT:    vlda.3d wh5, [p0], d0; vshuffle x9, x7, x0, r8; vmac cm2, cm2, x9, x6, r4
; ZOL-NEXT:    vlda wh10, [p1], #32; vmov x6, x10; vmac cm6, cm6, x9, x8, r4
; ZOL-NEXT:    vlda wl1, [p1], #32; vmov x8, x1; vmac cm3, cm3, x11, x6, r4
; ZOL-NEXT:    vlda wh1, [p1], #32; add r0, r1, #33; mov r1, p0; vmac cm7, cm7, x11, x8, r4
; ZOL-NEXT:  .L_LEnd0:
...
; ZOL-NEXT:    lda dn7, [sp, #-92]; vmac cm5, cm6, x0, x8, r4 // 4-byte Folded Reload
; ZOL-NEXT:    vmac cm4, cm5, x9, x8, r4
; ZOL-NEXT:    lda dj7, [sp, #-88]; vshift.align x4, x4, s1, x3, r0; vmac cm8, cm4, x7, x8, r4 // 4-byte Folded Reload
; ZOL-NEXT:    vshift.align x2, x2, s1, x5, r0; vmac cm3, cm3, x11, x6, r4
; ZOL-NEXT:    vshuffle x6, x4, x2, r2
; ZOL-NEXT:    vmac cm6, cm7, x6, x8, r4
; ZOL-NEXT:    vshuffle x8, x6, x0, r8; vmac cm7, cm0, x6, x10, r4
; ZOL-NEXT:    st dn7, [sp, #-92] // 4-byte Folded Spill
; ZOL-NEXT:    vshuffle x3, x4, x2, r3; vmac cm0, cm1, x8, x10, r4
; ZOL-NEXT:    st dj7, [sp, #-88] // 4-byte Folded Spill
; ZOL-NEXT:    vshuffle x5, x3, x0, r8; vmac cm1, cm2, x3, x10, r4
; ZOL-NEXT:    vst.srs.s16.s32 bmh7, s2, [p3, #32]; mov s3, r6
; ZOL-NEXT:    vst.srs.s16.s32 bml7, s3, [p3], #64; vmac cm2, cm3, x5, x10, r4
; ZOL-NEXT:    vst.srs.s16.s32 bmh0, s3, [p3, #32]
; ZOL-NEXT:    vst.srs.s16.s32 bml0, s3, [p3], m4; vmac cm3, cm8, x6, x1, r4
; ZOL-NEXT:    vst.srs.s16.s32 bmh1, s3, [p3, #32]
; ZOL-NEXT:    lda m7, [sp, #-96]; vst.srs.s16.s32 bml1, s3, [p3], #64; vmac cm8, cm4, x8, x1, r4 // 4-byte Folded Reload
; ZOL-NEXT:    lda dc7, [sp, #-84]; vst.srs.s16.s32 bmh2, s3, [p3, #32]; mov m1, r26 // 4-byte Folded Reload
; ZOL-NEXT:    vst.srs.s16.s32 bml2, s3, [p3], m1; vmac cm5, cm5, x3, x1, r4
; ZOL-NEXT:    vst.srs.s16.s32 bmh3, s3, [p3, #32]; mov dj5, r11
; ZOL-NEXT:    vst.srs.s16.s32 bml3, s3, [p3], #64; mov m2, r12; vmac cm4, cm6, x5, x1, r4
; ZOL-NEXT:    vst.srs.s16.s32 bmh8, s3, [p3, #32]; mov m3, r13
