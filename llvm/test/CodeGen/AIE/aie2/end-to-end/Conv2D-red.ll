...
; ASM-NEXT:    mova dj3, #0; paddb [sp], #96
; ASM-NEXT:    // implicit-def: $x2
; ASM-NEXT:    // implicit-def: $x4
; ASM-NEXT:    st p7, [sp, #-96] // 4-byte Folded Spill
; ASM-NEXT:    mov p7, sp
; ASM-NEXT:    paddb [p7], #-108; mov dc0, dj3
; ASM-NEXT:    lda m0, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-112; mov dc4, dj3
; ASM-NEXT:    lda dj0, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-116; mov dc2, dj3
; ASM-NEXT:    lda dj4, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-120; mov dc6, dj3
; ASM-NEXT:    lda dn0, [p7, #0]; st p6, [sp, #-92] // 4-byte Folded Spill
; ASM-NEXT:    mov p7, sp
; ASM-NEXT:    paddb [p7], #-124; st dc2, [sp, #-44] // 4-byte Folded Spill
; ASM-NEXT:    lda dn4, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-132; st dc6, [sp, #-28] // 4-byte Folded Spill
; ASM-NEXT:    lda m2, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-136
...
; ASM-NEXT:    paddb [p7], #-152; st dj2, [sp, #-48] // 4-byte Folded Spill
; ASM-NEXT:    lda m1, [p7, #0]; st dj6, [sp, #-32] // 4-byte Folded Spill
; ASM-NEXT:    mov p7, sp
; ASM-NEXT:    paddb [p7], #-156
; ASM-NEXT:    lda dj1, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-160; st dn2, [sp, #-52] // 4-byte Folded Spill
; ASM-NEXT:    lda dj5, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-164; st dn6, [sp, #-36] // 4-byte Folded Spill
; ASM-NEXT:    lda dn1, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-168; mov dj2, dj3
; ASM-NEXT:    lda dn5, [p7, #0]; st m1, [sp, #-88] // 4-byte Folded Spill
; ASM-NEXT:    mov p7, sp
; ASM-NEXT:    paddb [p7], #-172; st dj1, [sp, #-80] // 4-byte Folded Spill
; ASM-NEXT:    lda m3, [p7, #0]; mov p7, sp
; ASM-NEXT:    lda dj3, [sp, #-80]; paddb [p7], #-176; st dj5, [sp, #-64] // 4-byte Folded Reload4-byte Folded Spill
; ASM-NEXT:    lda dj7, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-180; st dj2, [sp, #-80] // 4-byte Folded Spill
; ASM-NEXT:    lda dn3, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-184; mov dc3, dj2
; ASM-NEXT:    lda dn7, [p7, #0]; st dn1, [sp, #-84] // 4-byte Folded Spill
; ASM-NEXT:    st dn5, [sp, #-68] // 4-byte Folded Spill
; ASM-NEXT:    nop
; ASM-NEXT:    mov p7, sp
; ASM-NEXT:    paddb [p7], #-196
; ASM-NEXT:    lda m1, [p7, #0]; mov p7, sp
; ASM-NEXT:    paddb [p7], #-200
; ASM-NEXT:    lda dj1, [p7, #0]; mov dc7, dj2
; ASM-NEXT:    mov dc2, dj2
; ASM-NEXT:    lda dj2, [sp, #-80]; mov dc6, dj2 // 4-byte Folded Reload
; ASM-NEXT:    mov p7, sp
; ASM-NEXT:    paddb [p7], #-204; st dc2, [sp, #-76] // 4-byte Folded Spill
; ASM-NEXT:    lda dn1, [p7, #0]; mov p7, sp
...
; ASM-NEXT:    st dn6, [sp, #-68] // 4-byte Folded Spill
; ASM-NEXT:    nop
; ASM-NEXT:    nop
; ASM-NEXT:    nop
...
; ASM-NEXT:    lda dc6, [sp, #-28]; vst.srs.s16.s32 bml4, s2, [p3], #64 // 4-byte Folded Reload
; ASM-NEXT:    vst.srs.s16.s32 bmh5, s2, [p3, #32]
; ASM-NEXT:    lda m6, [sp, #-40]; vst.srs.s16.s32 bml5, s2, [p3], m6 // 4-byte Folded Reload
; ASM-NEXT:    vst.srs.s16.s32 bmh6, s2, [p3, #32]
; ASM-NEXT:    vst.srs.s16.s32 bml6, s2, [p3], #64
; ASM-NEXT:    vst.srs.s16.s32 bmh7, s2, [p3, #32]
; ASM-NEXT:    lda m2, [sp, #-56]; vst.srs.s16.s32 bml7, s2, [p3], m2 // 4-byte Folded Reload
...
; ASM-NEXT:    lda dc2, [sp, #-76]; st m6, [sp, #-40] // 4-byte Folded Reload4-byte Folded Spill
; ASM-NEXT:    lda m6, [sp, #-72]; st dn6, [sp, #-36] // 4-byte Folded Reload4-byte Folded Spill
; ASM-NEXT:    lda dn6, [sp, #-68]; st dj6, [sp, #-32] // 4-byte Folded Reload4-byte Folded Spill
; ASM-NEXT:    lda dj6, [sp, #-64]; st dc6, [sp, #-28] // 4-byte Folded Reload4-byte Folded Spill
; ASM-NEXT:    lda dc6, [sp, #-60] // 4-byte Folded Reload
; ASM-NEXT:    st dn2, [sp, #-84] // 4-byte Folded Spill
...
; ASM-NEXT:    padda.3d [p1], d3; st dc6, [sp, #-60] // 4-byte Folded Spill Delay Slot 2
; ASM-NEXT:    padda.2d [p3], d1 // Delay Slot 1
; ASM-NEXT:  // %bb.4: // %exitStub
; ASM-NEXT:    lda p7, [sp, #-96] // 4-byte Folded Reload
; ASM-NEXT:    lda p6, [sp, #-92] // 4-byte Folded Reload
; ASM-NEXT:    ret lr
; ASM-NEXT:    nop // Delay Slot 5
; ASM-NEXT:    nop // Delay Slot 4
; ASM-NEXT:    nop // Delay Slot 3
; ASM-NEXT:    nop // Delay Slot 2
; ASM-NEXT:    paddb [sp], #-96 // Delay Slot 1
newFuncRoot:
