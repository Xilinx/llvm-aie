...
; ASM-NEXT:    nopb ; mova dj3, #0; nops ; nopxm ; nopv
; ASM-NEXT:    mov s0, r0
; ASM-NEXT:    mov s1, r1
; ASM-NEXT:    mov s2, r6
; ASM-NEXT:    mov m7, p4
...
; ASM-NEXT:    mov r15, dj3
; ASM-NEXT:    mov dc2, dj3
; ASM-NEXT:    paddb [sp], #32; mov dc6, dj3
; ASM-NEXT:    st p6, [sp, #-28] // 4-byte Folded Spill
; ASM-NEXT:    mov p6, sp
; ASM-NEXT:    paddb [p6], #-44; mov dc3, dj3
; ASM-NEXT:    lda m0, [p6, #0]; mov p6, sp
; ASM-NEXT:    paddb [p6], #-48; mov dc7, dj3
; ASM-NEXT:    lda dj0, [p6, #0]; mov p6, sp
; ASM-NEXT:    paddb [p6], #-52; st p7, [sp, #-32] // 4-byte Folded Spill
; ASM-NEXT:    lda dj4, [p6, #0]; mov p6, sp
; ASM-NEXT:    paddb [p6], #-56; mov p7, sp
; ASM-NEXT:    lda dn0, [p6, #0]
; ASM-NEXT:    paddb [p7], #-136; mov p6, sp
; ASM-NEXT:    lda r25, [p7, #0]; paddb [p6], #-60
...
; ASM-NEXT:    paddb [p6], #-88
; ASM-NEXT:    lda r13, [p6, #0]; mov p6, sp
; ASM-NEXT:    paddb [p6], #-92; mov p7, sp
; ASM-NEXT:    lda dj2, [p6, #0]
; ASM-NEXT:    paddb [p7], #-64; mov p6, sp
; ASM-NEXT:    lda r28, [p7, #0]; paddb [p6], #-96
; ASM-NEXT:    lda dj6, [p6, #0]; mov p6, sp
; ASM-NEXT:    paddb [p6], #-100
; ASM-NEXT:    lda dn2, [p6, #0]; mov p6, sp
; ASM-NEXT:    paddb [p6], #-104
; ASM-NEXT:    lda dn6, [p6, #0]; mov p6, sp
; ASM-NEXT:    paddb [p6], #-108
; ASM-NEXT:    lda r14, [p6, #0]
; ASM-NEXT:    mov p6, sp
; ASM-NEXT:    paddb [p6], #-112
; ASM-NEXT:    lda dj7, [p6, #0]; mov p6, sp
; ASM-NEXT:    paddb [p6], #-116
; ASM-NEXT:    lda dn3, [p6, #0]; mov p6, sp
; ASM-NEXT:    paddb [p6], #-120
; ASM-NEXT:    lda dn7, [p6, #0]; mov p6, sp
...
; ASM-NEXT:    lda m4, [p6, #0]; mov p6, sp
; ASM-NEXT:    paddb [p6], #-36
; ASM-NEXT:    lda r27, [p6, #0]; paddb [p7], #-128; mov p6, sp
; ASM-NEXT:    lda r30, [p7, #0]; paddb [p6], #-124; movx r8, #11; mov r31, dj3
; ASM-NEXT:    lda r29, [p6, #0]; movx r9, #31
...
; ASM-NEXT:    vlda.ups.s32.s16 bmh0, s0, [p2, #32]; nopb ; nopx
; ASM-NEXT:    vlda.ups.s32.s16 bml0, s0, [p2], m7
; ASM-NEXT:    vlda.ups.s32.s16 bmh1, s0, [p2, #32]
; ASM-NEXT:    vlda.ups.s32.s16 bml1, s0, [p2], m6
; ASM-NEXT:    vlda.ups.s32.s16 bmh2, s0, [p2, #32]
; ASM-NEXT:    vlda.ups.s32.s16 bml2, s0, [p2], m7
; ASM-NEXT:    vlda.ups.s32.s16 bmh3, s0, [p2, #32]; mov m1, r27
...
; ASM-NEXT:    vlda.ups.s32.s16 bml5, s0, [p2], m6
; ASM-NEXT:    vlda.ups.s32.s16 bmh6, s0, [p2, #32]
; ASM-NEXT:    vlda.ups.s32.s16 bml6, s0, [p2], m7; mov r0, p0
...
; ASM-NEXT:    vlda wl6, [p0], m4; nopx
; ASM-NEXT:    vlda wh6, [p0], m4
; ASM-NEXT:    vlda wl8, [p0], m4
...
; ASM-NEXT:    add r0, r0, #-1; vshuffle x5, x3, x0, r8; vmac cm2, cm2, x3, x10, r4
; ASM-NEXT:    jnz r0, #.LBB0_2; vmac cm1, cm1, x1, x10, r4
; ASM-NEXT:    vmac cm3, cm3, x5, x10, r4 // Delay Slot 5
; ASM-NEXT:    vmac cm4, cm4, x8, x6, r4 // Delay Slot 4
; ASM-NEXT:    mov r1, p0; vmac cm5, cm5, x1, x6, r4 // Delay Slot 3
; ASM-NEXT:    and r1, r1, r9; vmac cm6, cm6, x3, x6, r4 // Delay Slot 2
...
; ASM-NEXT:    vst.srs.s16.s32 bmh1, s2, [p3, #32]; mov m1, r29
; ASM-NEXT:    vst.srs.s16.s32 bml1, s2, [p3], m1
...
; ASM-NEXT:    vst.srs.s16.s32 bmh4, s2, [p3, #32]
; ASM-NEXT:    vst.srs.s16.s32 bml4, s2, [p3], #64; mov m5, r24
; ASM-NEXT:    vst.srs.s16.s32 bmh5, s2, [p3, #32]; mov dj5, r25
; ASM-NEXT:    vst.srs.s16.s32 bml5, s2, [p3], m1; mov dn5, r26
; ASM-NEXT:    vst.srs.s16.s32 bmh6, s2, [p3, #32]; mov dc5, r31
; ASM-NEXT:    vst.srs.s16.s32 bml6, s2, [p3], #64; mov m2, r13
; ASM-NEXT:    vst.srs.s16.s32 bmh7, s2, [p3, #32]; mov m1, r10
; ASM-NEXT:    padda.2d [p3], d5; vst.srs.s16.s32 bml7, s2, [p3, #0]; mov dj5, r11
; ASM-NEXT:    add r7, r7, #-1; mov dn5, r12
; ASM-NEXT:    jnz r7, #.LBB0_1
; ASM-NEXT:    mov r31, dc5 // Delay Slot 5
; ASM-NEXT:    mov dc5, r15 // Delay Slot 4
; ASM-NEXT:    padda.3d [p0], d1; mov m1, r28 // Delay Slot 3
; ASM-NEXT:    padda.3d [p1], d2; paddb [p2], m1; mov m3, r14 // Delay Slot 2
; ASM-NEXT:    padda.3d [p2], d3; mov r15, dc5 // Delay Slot 1
