...
; ASM-NEXT:    // implicit-def: $x6
; ASM-NEXT:    // implicit-def: $x5
; ASM-NEXT:  .LBB0_1: // %outer.loop.header
; ASM-NEXT:    // =>This Loop Header: Depth=1
; ASM-NEXT:    // Child Loop BB0_2 Depth 2
; ASM-NEXT:    vlda.ups.s32.s16 bmh1, s0, [p2, #32]; nopxm
; ASM-NEXT:    vlda.ups.s32.s16 bml1, s0, [p2], m7
; ASM-NEXT:    vlda.ups.s32.s16 bmh4, s0, [p2, #32]; mov m2, p5
; ASM-NEXT:    vlda.ups.s32.s16 bml4, s0, [p2], m2
; ASM-NEXT:    vlda.ups.s32.s16 bmh2, s0, [p2, #32]
; ASM-NEXT:    vlda.ups.s32.s16 bml2, s0, [p2], m7
; ASM-NEXT:    vlda.ups.s32.s16 bmh5, s0, [p2, #32]; mov m1, r10
...
; ASM-NEXT:    vlda.ups.s32.s16 bml6, s0, [p2], m2; mov r0, p0
; ASM-NEXT:    vlda.ups.s32.s16 bmh0, s0, [p2, #32]; movxm ls, #.LBB0_2
; ASM-NEXT:    vlda.ups.s32.s16 bml0, s0, [p2], m7; movxm le, #.L_LEnd0
...
; ASM-NEXT:    vldb wl8, [p0], m6; nopa ; nops ; nopxm ; nopv
; ASM-NEXT:    vldb wh8, [p0], m6; nopxm
; ASM-NEXT:    vldb wl3, [p0], m6
; ASM-NEXT:    vldb.3d wh3, [p0], d0
; ASM-NEXT:    nop
; ASM-NEXT:    vldb wl10, [p1], #32
; ASM-NEXT:    vldb wh10, [p1], #32
; ASM-NEXT:    vldb wl1, [p1], #32
; ASM-NEXT:    vldb wh1, [p1], #32
; ASM-NEXT:    vshift.align x6, x6, s1, x8, r0
; ASM-NEXT:    vshift.align x5, x5, s1, x3, r0
; ASM-NEXT:    vshuffle x7, x6, x5, r2
; ASM-NEXT:    vshuffle x9, x6, x5, r3
; ASM-NEXT:    vmac cm1, cm1, x7, x10, r4
; ASM-NEXT:    vmac cm2, cm2, x9, x10, r4
; ASM-NEXT:    vshuffle x4, x7, x0, r8; vmac cm3, cm3, x7, x1, r4
; ASM-NEXT:    vshuffle x2, x9, x0, r8; vmac cm0, cm0, x9, x1, r4
; ASM-NEXT:    vmac cm4, cm4, x4, x10, r4
; ASM-NEXT:    mov r0, p0; vmac cm5, cm5, x2, x10, r4
; ASM-NEXT:    and r0, r0, r9; vmac cm6, cm6, x4, x1, r4
; ASM-NEXT:  .L_LEnd0:
; ASM-NEXT:    nopb ; nopa ; nops ; add r0, r0, #33; nopm ; vmac cm7, cm7, x2, x1, r4
; ASM-NEXT:  // %bb.3: // %outer.loop.latch
; ASM-NEXT:    // in Loop: Header=BB0_1 Depth=1
; ASM-NEXT:    nopa ; nopb ; nopx ; vst.srs.s16.s32 bmh1, s2, [p3, #32]
; ASM-NEXT:    vst.srs.s16.s32 bml1, s3, [p3], #64
; ASM-NEXT:    vst.srs.s16.s32 bmh4, s3, [p3, #32]
; ASM-NEXT:    vst.srs.s16.s32 bml4, s3, [p3], m4
; ASM-NEXT:    vst.srs.s16.s32 bmh2, s3, [p3, #32]
; ASM-NEXT:    vst.srs.s16.s32 bml2, s3, [p3], #64
; ASM-NEXT:    vst.srs.s16.s32 bmh5, s3, [p3, #32]; mov m1, r25
; ASM-NEXT:    vst.srs.s16.s32 bml5, s3, [p3], m1
; ASM-NEXT:    vst.srs.s16.s32 bmh3, s3, [p3, #32]
; ASM-NEXT:    vst.srs.s16.s32 bml3, s3, [p3], #64
; ASM-NEXT:    vst.srs.s16.s32 bmh6, s3, [p3, #32]; mov dc5, r27
; ASM-NEXT:    vst.srs.s16.s32 bml6, s3, [p3], m4; mov dn5, r28
; ASM-NEXT:    vst.srs.s16.s32 bmh0, s3, [p3, #32]; mov dj5, r29
; ASM-NEXT:    vst.srs.s16.s32 bml0, s3, [p3], #64; mov m2, r15
; ASM-NEXT:    vst.srs.s16.s32 bmh7, s3, [p3, #32]; mov m1, r12
; ASM-NEXT:    vst.2d.srs.s16.s32 bml7, s3, [p3], d5; mov dj5, r13
; ASM-NEXT:    add r7, r7, #-1; mov dn5, r14
; ASM-NEXT:    jnz r7, #.LBB0_1
; ASM-NEXT:    mov r27, dc5 // Delay Slot 5
; ASM-NEXT:    mov dc5, r26 // Delay Slot 4
; ASM-NEXT:    padda.3d [p0], d1; mov m1, r11 // Delay Slot 3
; ASM-NEXT:    padda.3d [p1], d2; paddb [p2], m1 // Delay Slot 2
; ASM-NEXT:    padda.3d [p2], d3; mov r26, dc5 // Delay Slot 1
; ASM-NEXT:  // %bb.4: // %exitStub
; ASM-NEXT:    lda p6, [sp, #-32] // 4-byte Folded Reload
; ASM-NEXT:    ret lr
