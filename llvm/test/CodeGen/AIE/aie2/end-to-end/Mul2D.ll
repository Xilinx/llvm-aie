...
; CHECK-NEXT:    mova r10, #1; paddb [p3], #-4; movx r3, #0
...
; CHECK-NEXT:    ne r2, r2, r10; mov p3, sp
...
; CHECK-NEXT:    vlda wl2, [p1], #32; add r0, r0, #-1; mov dc0, r3
; CHECK-NEXT:    mov dc4, r4
; CHECK-NEXT:    vlda.3d wl4, [p0], d0; vmov wh4, wl0
; CHECK-NEXT:    mov crSRSSign, r2
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vlda wl2, [p1], #32; vmul cm0, x4, x2, r1
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    nop
; CHECK-NEXT:    vmul cm0, x4, x2, r1
; CHECK-NEXT:    nop
; CHECK-NEXT:    mov crSRSSign, #0
; CHECK-NEXT:    jnz r0, #.LBB0_2
; CHECK-NEXT:    mov crSRSSign, r2 // Delay Slot 5
; CHECK-NEXT:    vst.srs.d8.s32 cm0, s0, [p2], #32 // Delay Slot 4
; CHECK-NEXT:    mov r3, dc0 // Delay Slot 3
; CHECK-NEXT:    mov r4, dc4 // Delay Slot 2
