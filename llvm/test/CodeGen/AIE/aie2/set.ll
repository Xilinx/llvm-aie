...
; CHECK-NEXT:    nopb ; nopa ; nops ; j #.LBB2_7; nopv
; CHECK-NEXT:    nopa ; nopx // Delay Slot 5
; CHECK-NEXT:    nop // Delay Slot 4
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    vlda wl4, [sp, #-32] // 32-byte Folded Reload Delay Slot 1
; CHECK-NEXT:    .p2align 4
...
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    vlda wh4, [sp, #-32] // 32-byte Folded Reload Delay Slot 1
; CHECK-NEXT:    .p2align 4
...
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    vlda wl5, [sp, #-32] // 32-byte Folded Reload Delay Slot 1
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB2_6: // %if.else.i
; CHECK-NEXT:    nopb ; vlda wh5, [sp, #-32]; nops ; nopxm ; nopv // 32-byte Folded Reload
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB2_7: // %_ZL13set_v256uint4iDv32_DU8_.exit
...
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    vlda amll0, [sp, #-32] // 32-byte Folded Reload Delay Slot 1
; CHECK-NEXT:    .p2align 4
...
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    nop // Delay Slot 2
; CHECK-NEXT:    vlda amlh0, [sp, #-32] // 32-byte Folded Reload Delay Slot 1
; CHECK-NEXT:    .p2align 4
...
; CHECK-NEXT:    nopb ; vlda amhh0, [sp, #-32]; nops ; nopxm ; nopv // 32-byte Folded Reload
; CHECK-NEXT:    .p2align 4
...
; CHECK-NEXT:    nop // Delay Slot 1
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB12_2: // %if.else.i
; CHECK-NEXT:    ret lr
; CHECK-NEXT:    nop // Delay Slot 5
; CHECK-NEXT:    nop // Delay Slot 4
; CHECK-NEXT:    nop // Delay Slot 3
; CHECK-NEXT:    vmov bmh0, bml1 // Delay Slot 2
; CHECK-NEXT:    nop // Delay Slot 1
entry:
  %0 = and i32 %idx, 1
  %cmp.i = icmp eq i32 %0, 0
