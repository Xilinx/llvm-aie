...
define void @call_sparse() {
  ...
  ; CHECK-NEXT:   ADJCALLSTACKUP 96, 0, implicit-def $sp, implicit $sp
  ...
  ; CHECK-NEXT:   G_STORE [[C1]](s128), [[PTR_ADD1]](p0) :: (store (s128) into stack - 96)
  ...
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 96, 0, implicit-def $sp, implicit $sp
