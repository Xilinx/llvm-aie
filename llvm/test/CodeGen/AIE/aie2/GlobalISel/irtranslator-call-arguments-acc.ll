...
define void @call_v16int64() {
  ...
  ; CHECK-NEXT:   JL @callee_v16int64, csr_aie2, implicit-def $lr, implicit $cm0, implicit $cm1, implicit $cm2, implicit $cm3, implicit $cm4, implicit $cm5, implicit $cm6, implicit $cm7, implicit $cm8
