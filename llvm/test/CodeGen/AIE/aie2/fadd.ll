...
; CHECK-NEXT:    nopa ; nopb ; lshl r1, r1, r0; mov r29, r16
...
; CHECK-NEXT:    or r16, r3, r3 // Delay Slot 1
entry:
...
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    mova r16, #0; nopb ; nopx ; mov r3, r16; nops
...
; CHECK-NEXT:    vmov x0, bmh0 // Delay Slot 3
