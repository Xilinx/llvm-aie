...
; RUN: opt -mtriple=aie2ps -passes=aa-eval --aie-alias-analysis-disambiguation=true -disable-output < %s 2>&1 | FileCheck %s --check-prefix=AIE-AA-DIS-ENABLE
; RUN: opt -mtriple=aie2ps -passes=aa-eval --aie-alias-analysis-disambiguation=false -disable-output \
...
declare { ptr, i20 } @llvm.aie2ps.add.2d(ptr, i20, i20, i20, i20)
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %1 = tail call { ptr, i20 } @llvm.aie2ps.add.2d(ptr %ptr_load, i20 0, i20 1, i20 2, i20 %counter_load)
  %2 = extractvalue { ptr, i20 } %1, 1
  %3 = extractvalue { ptr, i20 } %1, 0
  load i8, ptr %3

  %5 = tail call { ptr, i20 } @llvm.aie2ps.add.2d(ptr %ptr_store, i20 0, i20 1, i20 2, i20 %counter_store)
  %6 = extractvalue { ptr, i20 } %5, 1
  %7 = extractvalue { ptr, i20 } %5, 0
  store i8 %b, ptr %7

  %8 = tail call { ptr, i20 } @llvm.aie2ps.add.2d(ptr %3, i20 0, i20 1, i20 2, i20 %2)
  %9 = extractvalue { ptr, i20 } %8, 1
  %10 = extractvalue { ptr, i20 } %8, 0
  load i8, ptr %10

  %12 = tail call { ptr, i20 } @llvm.aie2ps.add.2d(ptr %7, i20 0, i20 1, i20 2, i20 %6)
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %5 = tail call { ptr, i20 } @llvm.aie2ps.add.2d(ptr %ptr_store, i20 16, i20 1, i20 2, i20 %counter_store)
  %6 = extractvalue { ptr, i20 } %5, 1
  %7 = extractvalue { ptr, i20 } %5, 0
  store i8 %b, ptr %7
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %12 = tail call { ptr, i20 } @llvm.aie2ps.add.2d(ptr %gep, i20 0, i20 1, i20 2, i20 %6)
  %13 = extractvalue { ptr, i20 } %12, 1
  %14 = extractvalue { ptr, i20 } %12, 0
  store i8 %b, ptr %14
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %1 = tail call { ptr, i20 } @llvm.aie2ps.add.2d(ptr %first_load_ptr, i20 0, i20 1, i20 2, i20 %counter_load)
  %2 = extractvalue { ptr, i20 } %1, 1
  %3 = extractvalue { ptr, i20 } %1, 0
  load i8, ptr %3

  %5 = tail call { ptr, i20 } @llvm.aie2ps.add.2d(ptr %first_store_ptr, i20 0, i20 1, i20 2, i20 %counter_store)
  %6 = extractvalue { ptr, i20 } %5, 1
  %7 = extractvalue { ptr, i20 } %5, 0
  store i8 %b, ptr %7
