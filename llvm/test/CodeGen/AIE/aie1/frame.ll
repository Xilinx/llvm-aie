...
define i32 @test() nounwind {
  ...
  ; FPELIM-NEXT:   ST_SPIL_PTR killed $lr, -12, implicit $sp :: (store (s32) into %stack.1)
  ; FPELIM-NEXT:   ST_SPIL_GPR killed $r10, -8, implicit $sp :: (store (s32) into %stack.2)
  ...
  ; FPELIM-NEXT:   ST_SPIL_GPR renamable $r10, -32, implicit $sp :: (store (s32) into %ir.1)
  ...
  ; FPELIM-NEXT:   $r10 = LDA_SPIL_GPR -8, implicit $sp :: (load (s32) from %stack.2)
  ; FPELIM-NEXT:   $lr = LR_LOAD -12, implicit-def $r15, implicit $sp :: (load (s32) from %stack.1)
  ...
  ; WITHFP-NEXT:   ST_SPIL_PTR killed $lr, -12, implicit $sp :: (store (s32) into %stack.1)
  ; WITHFP-NEXT:   ST_SPIL_GPR killed $r10, -8, implicit $sp :: (store (s32) into %stack.2)
  ...
  ; WITHFP-NEXT:   ST_SPIL_GPR renamable $r10, -32, implicit $sp :: (store (s32) into %ir.1)
  ...
  ; WITHFP-NEXT:   $r10 = LDA_SPIL_GPR -8, implicit $sp :: (load (s32) from %stack.2)
  ; WITHFP-NEXT:   $lr = LR_LOAD -12, implicit-def $r15, implicit $sp :: (load (s32) from %stack.1)
