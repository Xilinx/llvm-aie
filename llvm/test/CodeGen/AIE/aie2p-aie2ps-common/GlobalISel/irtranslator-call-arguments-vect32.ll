...
define void @call_v2bf16() {
  ...
  ; CHECK-NEXT:   PseudoJL @callee_v2bf16, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1, implicit $r2, implicit $r3, implicit $r4, implicit $r5, implicit $r6, implicit $r7
...
define void @call_v2int16() {
  ...
  ; CHECK-NEXT:   $r6 = COPY [[BUILD_VECTOR]](<2 x s16>)
  ; CHECK-NEXT:   $r7 = COPY [[BUILD_VECTOR]](<2 x s16>)
  ; CHECK-NEXT:   PseudoJL @callee_v2int16, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1, implicit $r2, implicit $r3, implicit $r4, implicit $r5, implicit $r6, implicit $r7
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 4, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
...
define void @call_v4int8() {
  ...
  ; CHECK-NEXT:   PseudoJL @callee_v4int8, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1, implicit $r2, implicit $r3, implicit $r4, implicit $r5, implicit $r6, implicit $r7
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 4, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
