...
; RUN: llc -mtriple=aie2p -O0 -stop-after=irtranslator -global-isel %s -o - 2>&1 | FileCheck -DREG=q %s
; RUN: llc -mtriple=aie2ps -O0 -stop-after=irtranslator -global-isel %s -o - 2>&1 | FileCheck -DREG=eg %s
...
define i128 @test_ret_i128() {
  ...
  ; CHECK-NEXT:   PseudoRET implicit $lr, implicit $[[REG]]0
  ret i128 0
}
