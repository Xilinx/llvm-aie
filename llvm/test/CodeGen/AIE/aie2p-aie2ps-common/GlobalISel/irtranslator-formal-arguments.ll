...
; RUN: llc -mtriple=aie2p -O0 -stop-after=irtranslator -global-isel %s -o - 2>&1 | FileCheck --check-prefixes CHECK,AIE2P %s
; RUN: llc -mtriple=aie2ps -O0 -stop-after=irtranslator -global-isel %s -o - 2>&1 | FileCheck --check-prefixes CHECK,AIE2PS %s
...
define void @test_arg_i128([3 x i128] %b, i128 %a) {
  ; AIE2P-LABEL: name: test_arg_i128
  ; AIE2P: fixedStack:
  ; AIE2P: bb.1 (%ir-block.0):
  ; AIE2P-NEXT:   liveins: $q0, $q1, $q2, $q3
  ; AIE2P-NEXT: {{  $}}
  ; AIE2P-NEXT:   [[COPY:%[0-9]+]]:_(s128) = COPY $q0
  ; AIE2P-NEXT:   [[COPY1:%[0-9]+]]:_(s128) = COPY $q2
  ; AIE2P-NEXT:   [[COPY2:%[0-9]+]]:_(s128) = COPY $q1
  ; AIE2P-NEXT:   [[COPY3:%[0-9]+]]:_(s128) = COPY $q3
  ; AIE2P-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @g_ptr_128
  ; AIE2P-NEXT:   G_STORE [[COPY3]](s128), [[GV]](p0) :: (store (s128) into @g_ptr_128, align 4)
  ; AIE2P-NEXT:   PseudoRET implicit $lr
  ;
  ; AIE2PS-LABEL: name: test_arg_i128
  ; AIE2PS: fixedStack:
  ; AIE2PS: bb.1 (%ir-block.0):
  ; AIE2PS-NEXT:   liveins: $eg0, $eg2, $eg4, $eg6
  ; AIE2PS-NEXT: {{  $}}
  ; AIE2PS-NEXT:   [[COPY:%[0-9]+]]:_(s128) = COPY $eg0
  ; AIE2PS-NEXT:   [[COPY1:%[0-9]+]]:_(s128) = COPY $eg2
  ; AIE2PS-NEXT:   [[COPY2:%[0-9]+]]:_(s128) = COPY $eg4
  ; AIE2PS-NEXT:   [[COPY3:%[0-9]+]]:_(s128) = COPY $eg6
  ; AIE2PS-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @g_ptr_128
  ; AIE2PS-NEXT:   G_STORE [[COPY3]](s128), [[GV]](p0) :: (store (s128) into @g_ptr_128, align 4)
...
define void @test_arg_i128_stack([4 x i128] %a, i128 %stack) {
  ; AIE2P-LABEL: name: test_arg_i128_stack
  ; AIE2P: fixedStack:
  ; AIE2P-NEXT:   - { id: 0, type: default, offset: -16, size: 16, alignment: 16, stack-id: default, 
  ...
  ; AIE2P-NEXT:   [[LOAD:%[0-9]+]]:_(s128) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (s128) from %fixed-stack.0)
  ; AIE2P-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @g_ptr_128
  ; AIE2P-NEXT:   G_STORE [[LOAD]](s128), [[GV]](p0) :: (store (s128) into @g_ptr_128, align 4)
  ; AIE2P-NEXT:   PseudoRET implicit $lr
  ;
  ; AIE2PS-LABEL: name: test_arg_i128_stack
  ; AIE2PS: fixedStack:
  ; AIE2PS: bb.1 (%ir-block.0):
  ; AIE2PS-NEXT:   liveins: $eg0, $eg2, $eg4, $eg6, $eg8
  ; AIE2PS-NEXT: {{  $}}
  ; AIE2PS-NEXT:   [[COPY:%[0-9]+]]:_(s128) = COPY $eg0
  ; AIE2PS-NEXT:   [[COPY1:%[0-9]+]]:_(s128) = COPY $eg2
  ; AIE2PS-NEXT:   [[COPY2:%[0-9]+]]:_(s128) = COPY $eg4
  ; AIE2PS-NEXT:   [[COPY3:%[0-9]+]]:_(s128) = COPY $eg6
  ; AIE2PS-NEXT:   [[COPY4:%[0-9]+]]:_(s128) = COPY $eg8
  ; AIE2PS-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @g_ptr_128
  ; AIE2PS-NEXT:   G_STORE [[COPY4]](s128), [[GV]](p0) :: (store (s128) into @g_ptr_128, align 4)
  ; AIE2PS-NEXT:   PseudoRET implicit $lr
