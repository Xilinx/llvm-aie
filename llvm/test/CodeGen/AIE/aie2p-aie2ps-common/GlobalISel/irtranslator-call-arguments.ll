...
; RUN: llc -mtriple=aie2p -O0 -stop-after=irtranslator %s -o - 2>&1 | FileCheck -DVER=p -DREG=q %s
; RUN: llc -mtriple=aie2ps -O0 -stop-after=irtranslator %s -o - 2>&1 | FileCheck -DVER=ps -DREG=eg %s
...
define void @test_call() {
  ...
  ; CHECK-NEXT:   PseudoJL @callee, csr_aie2[[VER]], implicit-def $lr
...
define void @test_indirect_call(void()* %func) {
  ...
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoJL_IND [[COPY]](p0), csr_aie2[[VER]], implicit-def $lr
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
  call void %func()
  ret void
...
define void @test_call_i32() {
  ...
  ; CHECK-NEXT:   PseudoJL @callee_i32, csr_aie2[[VER]], implicit-def $lr, implicit $r0
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
...
define void @test_call_i64() {
  ...
  ; CHECK-NEXT:   PseudoJL @callee_i64, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
...
define void @test_call_i128() {
  ...
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   $[[REG]]0 = COPY [[C]](s128)
  ; CHECK-NEXT:   PseudoJL @callee_i128, csr_aie2[[VER]], implicit-def $lr, implicit $[[REG]]0
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
...
define void @test_abi_exts_call_i1(i1* %addr) {
  ...
  ; CHECK-NEXT:   PseudoJL @take_i1, csr_aie2[[VER]], implicit-def $lr, implicit $r0
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
...
define void @test_abi_exts_call_i8(i8* %addr) {
  ...
  ; CHECK-NEXT:   $r0 = COPY [[ANYEXT]](s32)
  ; CHECK-NEXT:   PseudoJL @take_i8, csr_aie2[[VER]], implicit-def $lr, implicit $r0
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
...
define void @test_abi_exts_call_i16(i16* %addr) {
  ...
  ; CHECK-NEXT:   $r0 = COPY [[ANYEXT]](s32)
  ; CHECK-NEXT:   PseudoJL @take_i16, csr_aie2[[VER]], implicit-def $lr, implicit $r0
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
...
define void @test_call_float() {
  ...
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   $r0 = COPY [[C]](s32)
  ; CHECK-NEXT:   PseudoJL @callee_float, csr_aie2[[VER]], implicit-def $lr, implicit $r0
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
...
define void @test_call_double() {
  ...
  ; CHECK-NEXT:   $r0 = COPY [[UV]](s32)
  ; CHECK-NEXT:   $r1 = COPY [[UV1]](s32)
  ; CHECK-NEXT:   PseudoJL @callee_double, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
...
define void @test_multiple_args(i64 %in) {
  ...
  ; CHECK-NEXT:   PseudoJL @multiple_args_callee, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1, implicit $r2
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
...
define void @test_call_stack_i1() {
  ...
  ; CHECK-NEXT:   PseudoJL @test_stack_slots_i1, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1, implicit $r2, implicit $r3, implicit $r4, implicit $r5, implicit $r6, implicit $r7
...
define void @test_call_stack_i8() {
  ...
  ; CHECK-NEXT:   $r6 = COPY [[C]](s32)
  ; CHECK-NEXT:   $r7 = COPY [[C]](s32)
  ; CHECK-NEXT:   PseudoJL @test_stack_slots_i8, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1, implicit $r2, implicit $r3, implicit $r4, implicit $r5, implicit $r6, implicit $r7
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 4, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   ADJCALLSTACKUP 4, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   [[SEXT:%[0-9]+]]:_(s32) = G_SEXT [[C1]](s8)
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(p0) = COPY $sp
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(s20) = G_CONSTANT i20 -4
  ; CHECK-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY1]], [[C3]](s20)
  ...
  ; CHECK-NEXT:   [[PTR_ADD2:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY2]], [[C4]](s20)
...
define void @test_call_stack_i16() {
  ...
  ; CHECK-NEXT:   $r6 = COPY [[C]](s32)
  ; CHECK-NEXT:   $r7 = COPY [[C]](s32)
  ; CHECK-NEXT:   PseudoJL @test_stack_slots_i16, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1, implicit $r2, implicit $r3, implicit $r4, implicit $r5, implicit $r6, implicit $r7
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 4, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   ADJCALLSTACKUP 4, 0, implicit-def $sp, implicit $sp
...
define void @test_call_stack_i32() {
  ...
  ; CHECK-NEXT:   $r6 = COPY [[C]](s32)
  ; CHECK-NEXT:   $r7 = COPY [[C]](s32)
  ; CHECK-NEXT:   PseudoJL @test_stack_slots_i32, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1, implicit $r2, implicit $r3, implicit $r4, implicit $r5, implicit $r6, implicit $r7
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 4, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
...
define void @test_call_stack_i64() {
  ...
  ; CHECK-NEXT:   $r6 = COPY [[C]](s32)
  ; CHECK-NEXT:   $r7 = COPY [[C]](s32)
  ; CHECK-NEXT:   PseudoJL @test_stack_slots_i64, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1, implicit $r2, implicit $r3, implicit $r4, implicit $r5, implicit $r6, implicit $r7
...
define void @test_call_stack_ptr() {
  ...
  ; CHECK-NEXT:   PseudoJL @test_stack_slots_ptr, csr_aie2[[VER]], implicit-def $lr, implicit $p0, implicit $p1, implicit $p2, implicit $p3, implicit $p4, implicit $p5
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 4, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
...
; FIXME
; %stack crosses the Stack-Reg boundary (for AIE2P), it should go on the stack.
...
define void @test_cross_stack_reg_boundary() {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $sp
  ; CHECK-NEXT:   [[C6:%[0-9]+]]:_(s20) = G_CONSTANT i20 -8
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C6]](s20)
  ; CHECK-NEXT:   G_STORE [[UV6]](s32), [[PTR_ADD]](p0) :: (store (s32) into stack - 8)
  ; CHECK-NEXT:   [[C7:%[0-9]+]]:_(s20) = G_CONSTANT i20 -4
  ; CHECK-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C7]](s20)
  ...
  ; CHECK-NEXT:   PseudoJL @cross_stack_reg_boundary, csr_aie2[[VER]], implicit-def $lr, implicit $r0, implicit $r1, implicit $r2, implicit $r3, implicit $r4, implicit $r5, implicit $r6, implicit $r7
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 8, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
...
; (AIE2P) Parameters are now passed from r2
...
define void @test_retcc_reserved_GPRs() {
  ...
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   $r2 = COPY [[C]](s32)
  ; CHECK-NEXT:   PseudoJL @retcc_reserved_GPRs, csr_aie2[[VER]], implicit-def $lr, implicit $r2, implicit-def $r0, implicit-def $r1
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY $r0
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(s32) = COPY $r1
  ; CHECK-NEXT:   [[MV:%[0-9]+]]:_(s64) = G_MERGE_VALUES [[COPY]](s32), [[COPY1]](s32)
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
...
define void @test_retcc_reserved_PTRs() {
  ...
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   $p1 = COPY [[C]](p0)
  ; CHECK-NEXT:   PseudoJL @retcc_reserved_PTRs, csr_aie2[[VER]], implicit-def $lr, implicit $p1, implicit-def $p0
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $p0
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   PseudoRET implicit $lr
