...
; NONEON-NOSVE-NEXT:    ldur x10, [x9, #194]
; NONEON-NOSVE-NEXT:    stur x10, [x9, #210]
...
; NONEON-NOSVE-NEXT:    ldr x10, [sp, #464]
; NONEON-NOSVE-NEXT:    str q0, [sp, #448]
; NONEON-NOSVE-NEXT:    str x10, [sp, #480]
; NONEON-NOSVE-NEXT:    ldurh w10, [x9, #13]
...
; NONEON-NOSVE-NEXT:    ldr x10, [sp, #1488]
; NONEON-NOSVE-NEXT:    str q0, [sp, #1472]
; NONEON-NOSVE-NEXT:    str x10, [sp, #1504]
; NONEON-NOSVE-NEXT:    ldurh w10, [x9, #13]
; NONEON-NOSVE-NEXT:    ldur w11, [x9, #9]
; NONEON-NOSVE-NEXT:    sturh w10, [x9, #29]
; NONEON-NOSVE-NEXT:    stur w11, [x9, #25]
...
; NONEON-NOSVE-NEXT:    ldurh w11, [x10, #13]
; NONEON-NOSVE-NEXT:    stur x9, [x10, #17]
; NONEON-NOSVE-NEXT:    ldur w9, [x10, #9]
; NONEON-NOSVE-NEXT:    sturh w11, [x10, #29]
; NONEON-NOSVE-NEXT:    stur w9, [x10, #25]
...
; NONEON-NOSVE-NEXT:    strh wzr, [sp, #462]
; NONEON-NOSVE-NEXT:    stur wzr, [x9, #250]
; NONEON-NOSVE-NEXT:    str h0, [sp, #448]
...
; NONEON-NOSVE-NEXT:    ldrh w10, [sp, #276]
; NONEON-NOSVE-NEXT:    str q0, [sp, #256]
; NONEON-NOSVE-NEXT:    strh w10, [sp, #292]
...
; NONEON-NOSVE-NEXT:    str q0, [sp, #208]
; NONEON-NOSVE-NEXT:    ldr x10, [sp, #208]
; NONEON-NOSVE-NEXT:    str h1, [sp, #240]
; NONEON-NOSVE-NEXT:    ldr q0, [sp, #240]
; NONEON-NOSVE-NEXT:    str x10, [sp, #224]
; NONEON-NOSVE-NEXT:    ldrh w10, [sp, #222]
; NONEON-NOSVE-NEXT:    str q0, [sp, #192]
; NONEON-NOSVE-NEXT:    strh w10, [sp, #238]
...
; NONEON-NOSVE-NEXT:    ldr h0, [x0]
; NONEON-NOSVE-NEXT:    stur xzr, [x9, #242]
; NONEON-NOSVE-NEXT:    strh wzr, [sp, #974]
; NONEON-NOSVE-NEXT:    stur wzr, [x9, #250]
; NONEON-NOSVE-NEXT:    str h0, [sp, #960]
; NONEON-NOSVE-NEXT:    ldr q0, [sp, #960]
...
; NONEON-NOSVE-NEXT:    ldrh w10, [sp, #788]
; NONEON-NOSVE-NEXT:    str q0, [sp, #768]
; NONEON-NOSVE-NEXT:    strh w10, [sp, #804]
...
; NONEON-NOSVE-NEXT:    str q0, [sp, #720]
; NONEON-NOSVE-NEXT:    ldr x10, [sp, #720]
; NONEON-NOSVE-NEXT:    str h2, [sp, #752]
; NONEON-NOSVE-NEXT:    ldr q0, [sp, #752]
; NONEON-NOSVE-NEXT:    str x10, [sp, #736]
; NONEON-NOSVE-NEXT:    ldrh w10, [sp, #734]
; NONEON-NOSVE-NEXT:    str q0, [sp, #704]
; NONEON-NOSVE-NEXT:    strh w10, [sp, #750]
; NONEON-NOSVE-NEXT:    ldur w10, [x9, #10]
; NONEON-NOSVE-NEXT:    stur w10, [x9, #26]
...
; NONEON-NOSVE-NEXT:    str q0, [sp, #528]
; NONEON-NOSVE-NEXT:    strh w9, [sp, #556]
...
; NONEON-NOSVE-NEXT:    ldr q1, [sp, #496]
; NONEON-NOSVE-NEXT:    str q1, [sp, #448]
; NONEON-NOSVE-NEXT:    ldur x10, [x9, #2]
; NONEON-NOSVE-NEXT:    stur x10, [x9, #18]
; NONEON-NOSVE-NEXT:    ldrh w10, [sp, #478]
; NONEON-NOSVE-NEXT:    strh w10, [sp, #494]
; NONEON-NOSVE-NEXT:    ldur w10, [x9, #10]
; NONEON-NOSVE-NEXT:    stur w10, [x9, #26]
