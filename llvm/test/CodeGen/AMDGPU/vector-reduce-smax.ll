...
; GFX8-GISEL-NEXT:    v_max_i16_sdwa v0, v0, sext(v6) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_1
...
; GFX8-GISEL-NEXT:    v_max_i16_sdwa v3, v3, v5 dst_sel:BYTE_3 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX9-GISEL-NEXT:    v_max_i16_sdwa v3, v3, s0 dst_sel:BYTE_3 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX8-GISEL-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GFX8-GISEL-NEXT:    v_max_i16_sdwa v3, v3, v4 dst_sel:BYTE_3 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX8-GISEL-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX8-GISEL-NEXT:    v_or_b32_e32 v0, v0, v3
; GFX8-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-GISEL-NEXT:    v_max_i16 v0, v0, v7
; GFX10-GISEL-NEXT:    v_max_i16 v3, v3, v4
...
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_max_i16 v3, v3, v4
...
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-GISEL-NEXT:    v_max_i16 v3, v3, v4
...
; GFX8-GISEL-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; GFX8-GISEL-NEXT:    v_max_i16_sdwa v7, sext(v7), sext(v8) dst_sel:BYTE_3 dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:BYTE_1
; GFX8-GISEL-NEXT:    v_or_b32_e32 v4, v4, v5
...
; GFX9-GISEL-NEXT:    v_and_b32_e32 v5, 0xff, v6
; GFX9-GISEL-NEXT:    v_max_i16_sdwa v7, sext(v7), sext(v9) dst_sel:BYTE_3 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:BYTE_3
; GFX9-GISEL-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
...
; GFX10-GISEL-NEXT:    v_max_i16 v5, v5, v10
; GFX10-GISEL-NEXT:    v_max_i16 v6, v6, v13
; GFX10-GISEL-NEXT:    v_bfe_i32 v10, v12, 24, 8
; GFX10-GISEL-NEXT:    v_max_i16 v4, v4, v14
; GFX10-GISEL-NEXT:    v_max_i16 v0, v0, v9
...
; GFX11-GISEL-NEXT:    v_max_i16 v6, v6, v9
; GFX11-GISEL-NEXT:    v_bfe_i32 v9, v12, 24, 8
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_and_b32_e32 v5, 0xff, v5
; GFX11-GISEL-NEXT:    v_max_i16 v4, v4, v13
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_and_b32_e32 v6, 0xff, v6
; GFX11-GISEL-NEXT:    v_max_i16 v7, v7, v9
; GFX11-GISEL-NEXT:    v_bfe_i32 v9, v8, 0, 8
; GFX11-GISEL-NEXT:    v_lshlrev_b32_e32 v5, 8, v5
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_max_i16 v0, v0, v9
; GFX11-GISEL-NEXT:    v_and_or_b32 v4, 0xff, v4, v5
...
; GFX11-GISEL-NEXT:    v_max_i16 v1, v1, v6
...
; GFX12-GISEL-NEXT:    v_max_i16 v6, v6, v9
; GFX12-GISEL-NEXT:    v_bfe_i32 v9, v12, 24, 8
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-GISEL-NEXT:    v_and_b32_e32 v5, 0xff, v5
; GFX12-GISEL-NEXT:    v_max_i16 v4, v4, v13
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-GISEL-NEXT:    v_and_b32_e32 v6, 0xff, v6
; GFX12-GISEL-NEXT:    v_max_i16 v7, v7, v9
; GFX12-GISEL-NEXT:    v_bfe_i32 v9, v8, 0, 8
; GFX12-GISEL-NEXT:    v_lshlrev_b32_e32 v5, 8, v5
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-GISEL-NEXT:    v_max_i16 v0, v0, v9
; GFX12-GISEL-NEXT:    v_and_or_b32 v4, 0xff, v4, v5
...
; GFX12-GISEL-NEXT:    v_max_i16 v1, v1, v6
