...
; CHECK-LABEL: define dso_local void @l(
; CHECK-SAME: ) local_unnamed_addr !dbg [[DBG16:![0-9]+]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:      #dbg_value(i32 undef, [[META19:![0-9]+]], !DIExpression(), [[META30:![0-9]+]])
; CHECK-NEXT:    store i32 1, ptr @f, align 4, !dbg [[DBG32:![0-9]+]]
; CHECK-NEXT:    store i32 poison, ptr @e, align 4, !dbg [[DBG42:![0-9]+]]
...
;.
; CHECK: [[META0:![0-9]+]] = !DIGlobalVariableExpression(var: [[META1:![0-9]+]], expr: !DIExpression())
; CHECK: [[META1]] = distinct !DIGlobalVariable(name: "f", scope: [[META2:![0-9]+]], file: [[META3:![0-9]+]], line: 5, type: [[META8:![0-9]+]], isLocal: false, isDefinition: true)
; CHECK: [[META2]] = distinct !DICompileUnit(language: DW_LANG_C99, file: [[META3]], producer: "{{.*}}clang version {{.*}}", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: [[META4:![0-9]+]], globals: [[META5:![0-9]+]], splitDebugInlining: false, nameTableKind: None)
; CHECK: [[META3]] = !DIFile(filename: "test.c", directory: {{.*}})
; CHECK: [[META4]] = !{}
; CHECK: [[META5]] = !{[[META6:![0-9]+]], [[META9:![0-9]+]], [[META0]]}
; CHECK: [[META6]] = !DIGlobalVariableExpression(var: [[META7:![0-9]+]], expr: !DIExpression())
; CHECK: [[META7]] = distinct !DIGlobalVariable(name: "d", scope: [[META2]], file: [[META3]], line: 5, type: [[META8]], isLocal: false, isDefinition: true)
; CHECK: [[META8]] = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
; CHECK: [[META9]] = !DIGlobalVariableExpression(var: [[META10:![0-9]+]], expr: !DIExpression())
; CHECK: [[META10]] = distinct !DIGlobalVariable(name: "e", scope: [[META2]], file: [[META3]], line: 5, type: [[META8]], isLocal: false, isDefinition: true)
; CHECK: [[DBG16]] = distinct !DISubprogram(name: "l", scope: [[META3]], file: [[META3]], line: 21, type: [[META17:![0-9]+]], scopeLine: 21, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: [[META2]], retainedNodes: [[META4]])
; CHECK: [[META17]] = !DISubroutineType(types: [[META18:![0-9]+]])
; CHECK: [[META18]] = !{null}
; CHECK: [[META19]] = !DILocalVariable(name: "j", scope: [[META20:![0-9]+]], file: [[META3]], line: 17, type: [[META22:![0-9]+]])
; CHECK: [[META20]] = distinct !DISubprogram(name: "k", scope: [[META3]], file: [[META3]], line: 16, type: [[META17]], scopeLine: 16, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: [[META2]], retainedNodes: [[META21:![0-9]+]])
; CHECK: [[META21]] = !{[[META19]]}
; CHECK: [[META22]] = !DIDerivedType(tag: DW_TAG_typedef, name: "c", file: [[META3]], line: 4, baseType: [[META23:![0-9]+]])
; CHECK: [[META23]] = distinct !DICompositeType(tag: DW_TAG_structure_type, file: [[META3]], line: 1, size: 32, elements: [[META24:![0-9]+]])
; CHECK: [[META24]] = !{[[META25:![0-9]+]], [[META26:![0-9]+]]}
; CHECK: [[META25]] = !DIDerivedType(tag: DW_TAG_member, name: "a", scope: [[META23]], file: [[META3]], line: 2, baseType: [[META8]], size: 32)
; CHECK: [[META26]] = !DIDerivedType(tag: DW_TAG_member, name: "b", scope: [[META23]], file: [[META3]], line: 3, baseType: [[META27:![0-9]+]], offset: 32)
; CHECK: [[META27]] = !DICompositeType(tag: DW_TAG_array_type, baseType: [[META8]], elements: [[META28:![0-9]+]])
; CHECK: [[META28]] = !{[[META29:![0-9]+]]}
; CHECK: [[META29]] = !DISubrange(count: -1)
; CHECK: [[META30]] = !DILocation(line: 0, scope: [[META20]], inlinedAt: [[META31:![0-9]+]])
; CHECK: [[META31]] = distinct !DILocation(line: 21, column: 12, scope: [[DBG16]])
; CHECK: [[DBG32]] = !DILocation(line: 0, scope: [[META33:![0-9]+]], inlinedAt: [[META41:![0-9]+]])
; CHECK: [[META33]] = distinct !DISubprogram(name: "i", scope: [[META3]], file: [[META3]], line: 10, type: [[META34:![0-9]+]], scopeLine: 10, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: [[META2]], retainedNodes: [[META37:![0-9]+]])
; CHECK: [[META34]] = !DISubroutineType(types: [[META35:![0-9]+]])
; CHECK: [[META35]] = !{null, [[META36:![0-9]+]]}
; CHECK: [[META36]] = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: [[META22]], size: 64)
; CHECK: [[META37]] = !{[[META38:![0-9]+]], [[META39:![0-9]+]]}
; CHECK: [[META38]] = !DILocalVariable(name: "h", arg: 1, scope: [[META33]], file: [[META3]], line: 10, type: [[META36]])
; CHECK: [[META39]] = !DILocalVariable(name: "j", scope: [[META33]], file: [[META3]], line: 11, type: [[META40:![0-9]+]])
; CHECK: [[META40]] = !DIBasicType(name: "long int", size: 64, encoding: DW_ATE_signed)
; CHECK: [[META41]] = distinct !DILocation(line: 19, column: 3, scope: [[META20]], inlinedAt: [[META31]])
; CHECK: [[DBG42]] = !DILocation(line: 14, column: 5, scope: [[META33]], inlinedAt: [[META41]])
; CHECK: [[DBG43]] = !DILocation(line: 21, column: 17, scope: [[DBG16]])
;.
