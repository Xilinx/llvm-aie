...
//===----------------------------------------------------------------------===//
//
// Unified aie prelegalizer combiner pass for all AIE architectures.
...
#define DEBUG_TYPE "aie-prelegalizer-combiner"
...
namespace {
class AIEPreLegalizerCombiner : public MachineFunctionPass {
public:
  static char ID;

  AIEPreLegalizerCombiner() : MachineFunctionPass(ID) {
    initializeAIEPreLegalizerCombinerPass(*PassRegistry::getPassRegistry());
  }

  StringRef getPassName() const override { return "AIE PreLegalizer Combiner"; }
...
bool AIEPreLegalizerCombiner::runOnMachineFunction(MachineFunction &MF) {
...
char AIEPreLegalizerCombiner::ID = 0;
...
FunctionPass *createAIEPreLegalizerCombiner() {
  return new AIEPreLegalizerCombiner();
}
} // end namespace llvm
