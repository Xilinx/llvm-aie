...
//===----------------------------------------------------------------------===//
/// \file
/// This file declares the targeting of the RegisterBankInfo class for AIE1.
/// \todo This should be generated by TableGen.
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_AIE_AIE1REGISTERBANKINFO_H
#define LLVM_LIB_TARGET_AIE_AIE1REGISTERBANKINFO_H
...
class AIEGenRegisterBankInfo : public AIEBaseRegisterBankInfo {
protected:
...
class AIE1RegisterBankInfo final : public AIEGenRegisterBankInfo {
...
public:
  AIE1RegisterBankInfo(const TargetRegisterInfo &TRI);
...
#endif // LLVM_LIB_TARGET_AIE_AIE1REGISTERBANKINFO_H
