...
// CHECK-LABEL: @greater_equal_fold_float
func.func @greater_equal_fold_float() -> tensor<4xi1> {
  ...
  %2 = "tosa.greater_equal"(%0, %1) : (tensor<4xf16>, tensor<4xf16>) -> tensor<4xi1>
...
// CHECK-LABEL: @greater_equal_fold_int
func.func @greater_equal_fold_int() -> tensor<4xi1> {
  // CHECK: [[RES:]] = "tosa.const"() <{value = dense<[true, true, true, false]>
  // CHECK-NOT: tosa.greater_equal
  // CHECK: return [[RES]]
  %0 = "tosa.const"() {value =
                        dense<[-17, 4, 0, 0]> :
...
// CHECK-LABEL: @greater_equal_fold_int_broadcast_simple
func.func @greater_equal_fold_int_broadcast_simple() -> tensor<3xi1> {
  ...
  %2 = "tosa.greater_equal"(%0, %1) : (tensor<3xi32>, tensor<1xi32>) -> tensor<3xi1>
  return %2 : tensor<3xi1>
}

// CHECK-LABEL: @greater_equal_fold_int_broadcast_complex
func.func @greater_equal_fold_int_broadcast_complex() -> tensor<3x3xi1> {
  ...
  %2 = "tosa.greater_equal"(%0, %1) : (tensor<3x1xi32>, tensor<1x3xi32>) -> tensor<3x3xi1>
